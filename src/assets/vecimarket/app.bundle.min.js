...
function XM_Accordion(t) {
    var s = {
      ...
      , n = function() {
        ...
        try {
            for (var o, r = d.accordions[Symbol.iterator](); !(t = (o = r.next()).done); t = !0) {
                var i = o.value;
                i.open && (i.content.style.height = "auto",
      ...
      , e = function() {
        ...
        if (!t.length)
            throw new Error("Couldn't find ".concat(s.triggerSelector, " in the DOM"));
        var n = !0
          , e = !(d.accordions = [])
          , o = void 0;
        try {
            for (var r, i = t[Symbol.iterator](); !(n = (r = i.next()).done); n = !0) {
                ...
                if (!c && !(c = a.parentElement.querySelector(s.contentSelector)))
                    throw new Error("Couldn't find ".concat(s.contentSelector, " in ").concat(s.triggerSelector, " nor as it's sibling"));
      ...
      , o = function() {
        ...
        try {
            for (var o, r = d.accordions[Symbol.iterator](); !(t = (o = r.next()).done); t = !0) {
                ...
                i.startOpen ? (i.content.style.height = "".concat(i.content.scrollHeight, "px"),
      ...
      , i = function() {
        ...
        try {
            ...
            }, i = d.accordions[Symbol.iterator](); !(t = (o = i.next()).done); t = !0)
                r()
        } catch (t) {
            n = !0,
            e = t
    ...
    return function t(n, e) {
        var o;
        for (var r in e)
            "object" !== _typeof(e[r]) || e[r]instanceof Date ? e[r]instanceof Date ? n[r] = new Date(e[r].getTime()) : n[r] = e[r] : (o = e[r]instanceof Array ? [] : {},
            void 0 === n[r] && (n[r] = o),
            t(n[r], e[r]))
    }(s, t),
    e(),
...
function XM_Dropdown(t) {
    var c, g = {
        ...
        if (g.controlToggle) {
            ...
            try {
                for (var y, v = c[Symbol.iterator](); !(f = (y = v.next()).done); f = !0) {
                    ...
                    if (!p)
                        throw new Error("".concat(g.container, " not found as sibling of ").concat(g.trigger));
                    var m = {};
        ...
        for (var n in t.parent.style.position = g.absolute ? "absolute" : "relative",
        S(t.container, {
            position: "absolute",
    ...
    return function t(n, r) {
        var o;
        for (var e in r)
            "object" !== _typeof(r[e]) || r[e]instanceof Date ? r[e]instanceof Date ? n[e] = new Date(r[e].getTime()) : n[e] = r[e] : (o = r[e]instanceof Array ? [] : {},
            void 0 === n[e] && (n[e] = o),
            t(n[e], r[e]))
    }(g, t),
    r(),
...
function XM_Hexagon(t) {
    var p = {
      ...
      , e = function() {
        ...
        p.scale.stop = p.scale.stop < p.scale.start ? p.scale.start : p.scale.stop,
        ...
        try {
            for (var n, r = h[Symbol.iterator](); !(t = (n = r.next()).done); t = !0) {
                ...
                if (p.gradient) {
                    ...
                    o.ctx.strokeStyle = p.lineColor,
                    o.ctx.fillStyle = p.lineColor;
                o.ctx.lineCap = p.lineCap,
                o.ctx.lineWidth = p.lineWidth
            }
        } catch (t) {
            i = !0,
            e = t
    ...
    function a(t) {
        for (var i = (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop) + window.innerHeight, e = t.canvas, n = e.offsetTop; e = e.offsetParent; )
            n += e.offsetTop;
        return n <= i
    }
    function d(t) {
        ...
        t.finishedDrawing = !0)) : (t.animation.currentProgress += t.animation.step,
        t.animation.currentProgress >= p.stopPoint && (t.animation.currentProgress = p.stopPoint,
        t.finishedDrawing = !0))),
    ...
    var o = function(t, i) {
      ...
      , s = function(n, t) {
        ...
        if (n.ctx.clearRect(0, 0, p.width, p.height),
        0 !== i) {
            if (n.ctx.beginPath(),
            p.roundedCorners) {
                ...
                if (p.clip || p.fill)
                    ...
                    for (; ; ) {
                        ...
                        if (i <= 5 / 6)
                            break;
                        if (n.ctx.quadraticCurveTo(0 + e, (p.height - v.sideWidth) / 2, 0 + e + r, o),
                        (g -= s) <= 0)
                            break;
                        if (f = {
                            x: 0 + e + r,
                ...
                p.clip || p.fill ? (n.ctx.moveTo(p.width / 2, 0),
            ...
            if (p.clip) {
                ...
                p.fill ? n.ctx.fill() : n.ctx.stroke()
        } else
            n.finishedDrawing = !0
    };
    ...
    function t(i, e) {
        var n;
        for (var r in e)
            "object" !== _typeof(e[r]) || e[r]instanceof Date ? e[r]instanceof Date ? i[r] = new Date(e[r].getTime()) : i[r] = e[r] : (n = e[r]instanceof Array ? [] : {},
            void 0 === i[r] && (i[r] = n),
            t(i[r], e[r]))
    }(p, t),
    i(),
    ...
    function() {
        ...
        try {
            ...
            }, o = h[Symbol.iterator](); !(t = (n = o.next()).done); t = !0)
                r()
        } catch (t) {
            i = !0,
            e = t
...
function XM_Popup(t) {
    function n() {
        ...
        "fade" === s.animation.type ? (r.popupContainer.style.opacity = 1,
        r.popupContainer.style.visibility = "visible") : "translate-in" === s.animation.type || "translate-out" === s.animation.type ? (r.popupContainer.style.visibility = "visible",
        ...
        r.popupContainer.style.transform = "translate(0, 0)") : "zoom-fade" === s.animation.type && (r.popupContainer.style.opacity = 1,
        r.popupContainer.style.visibility = "visible",
    ...
    var s = {
      ...
      , l = function() {
        if (r.popupContainer = document.querySelector(s.container),
        !r.popupContainer)
      ...
      , f = function() {
        r.visible = !1,
        "fade" === s.animation.type ? (r.popupContainer.style.opacity = 0,
        ...
        r.popupContainer.style.transform = "translate(0, -".concat(s.animation.translateOffset, "px)")) : "translate-out-fade" === s.animation.type ? (r.popupContainer.style.opacity = 0,
        r.popupContainer.style.visibility = "hidden",
        r.popupContainer.style.transform = "translate(0, ".concat(s.animation.translateOffset, "px)")) : "zoom-fade" === s.animation.type && (r.popupContainer.style.opacity = 0,
        r.popupContainer.style.visibility = "hidden",
      ...
      , m = function() {
        ...
        s.closeOnKey && window.addEventListener("keydown", function(t) {
    ...
    return function t(n, e) {
        var o;
        for (var i in e)
            "object" !== _typeof(e[i]) || e[i]instanceof Date ? e[i]instanceof Date ? n[i] = new Date(e[i].getTime()) : n[i] = e[i] : (o = e[i]instanceof Array ? [] : {},
            void 0 === n[i] && (n[i] = o),
            t(n[i], e[i]))
    }(s, t),
    e(),
...
function XM_ProgressBar(h) {
    ...
    var p = {
      ...
      , u = function() {
        if (l.container = document.querySelector(p.container),
        !l.container)
            throw Error('Unable to find "'.concat(p.container, '" on the DOM'));
        o.width = p.width,
        o.height = p.height,
      ...
      , m = function() {
        ...
        e !== 1 / 0 && (p.width = p.breakpoints[e].width,
      ...
      , w = function(e) {
        ...
        if (a(t),
        p.linkElContainer && p.innerTextFollowsProgress && (p.linkElContainer.style.left = "".concat(t, "px")),
        k(),
        0 != t) {
            if (r.beginPath(),
            "butt" === p.lineCap && (r.moveTo(0, e.height / 2),
            r.lineTo(t, e.height / 2)),
            "round" === p.lineCap) {
                var n = r.lineWidth / 2
                  , i = t - n;
                p.reverse ? (r.moveTo(e.width - n, e.height / 2),
                e.width - t <= n ? r.lineTo(n, e.height / 2) : r.lineTo(e.width - t, e.height / 2)) : (r.moveTo(n, e.height / 2),
      ...
      , T = function() {
        ...
        p.linkElContainer || (p.linkElContainer = document.createElement("div"),
      ...
      , a = function(e) {
        if (p.linkText) {
            ...
            p.innerLink && (p.linkEl.innerHTML = t,
    ...
    function k() {
        if (p.gradient) {
            ...
            r.strokeStyle = p.lineColor;
        r.lineCap = p.lineCap,
        r.lineWidth = p.height
    }
    function v() {
        for (var e = (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop) + window.innerHeight, t = o, n = t.offsetTop; t = t.offsetParent; )
            n += t.offsetTop;
        return n <= e
    }
    function x() {
        ...
        l.done = !0)) : (p.animation.currentProgress += p.animation.step,
        p.animation.currentProgress >= p.stopPoint && (p.animation.currentProgress = p.stopPoint,
        l.done = !0))),
    ...
    var E = function(e) {
        ...
        0 === t)
            return p.emptyText && (p.emptyTextContainer ? p.emptyTextEl = document.querySelector(p.emptyTextContainer) : p.emptyTextEl = p.linkEl.parentElement,
            p.emptyTextEl.innerHTML = p.emptyText),
            void (l.done = !0);
        if (r.beginPath(),
        "butt" === p.lineCap && (r.moveTo(0, p.height / 2),
        r.lineTo(t, p.height / 2),
        r.stroke()),
        "round" === p.lineCap) {
            var n = r.lineWidth / 2
              , i = t - n;
            p.reverse ? (r.moveTo(p.width - n, p.height / 2),
            p.width - t <= n ? r.lineTo(n, p.height / 2) : r.lineTo(p.width - t, p.height / 2)) : (r.moveTo(n, p.height / 2),
            i < n ? r.lineTo(n, p.height / 2) : r.lineTo(i, p.height / 2)),
            r.stroke(),
            p.buttEnd && (r.lineCap = "butt",
            p.reverse ? (r.moveTo(p.width - t, p.height / 2),
            r.lineTo(p.width - t - n, p.height / 2)) : (r.moveTo(i, p.height / 2),
            r.lineTo(t, p.height / 2)),
            r.stroke(),
            r.lineCap = "round")
        }
        p.barText && s(t),
        p.completeText && t === p.width && (p.completeTextContainer ? p.completeTextEl = document.querySelector(p.completeTextContainer) : p.completeTextEl = p.linkEl.parentElement,
    ...
    var b = function e(t, n) {
        var i;
        for (var o in n)
            "object" !== _typeof(n[o]) || n[o]instanceof Date ? n[o]instanceof Date ? t[o] = new Date(n[o].getTime()) : t[o] = n[o] : (i = n[o]instanceof Array ? [] : {},
            void 0 === t[o] && (t[o] = i),
            e(t[o], n[o]))
    };
    !function() {
        if (b(p, h),
        "auto" === p.width || void 0 === p.width) {
        ...
        m(),
        h.scale && (p.scale.stop = p.scale.stop > p.scale.end ? p.scale.end : p.scale.stop,
        p.scale.stop = p.scale.stop < p.scale.start ? p.scale.start : p.scale.stop,
        ...
        k(),
        y(),
        p.animateOnScroll ? v() ? window.requestAnimationFrame(x) : window.addEventListener("scroll", function e() {
            v() && (window.requestAnimationFrame(x),
            window.removeEventListener("scroll", e))
        }) : p.controlAnimation || E(),
        void 0 !== p.split)
            if (void 0 !== p.split.parts)
                for (var t = (p.width - p.split.gap * (p.split.parts - 1)) / p.split.parts, n = -p.split.gap, i = 0; i < p.split.parts; i++)
                    f({
                        width: p.split.gap,
                        color: p.split.color,
                        offset: n,
...
function XM_Tab(n) {
    var a = {
      ...
      , i = function() {
        return s.triggers = document.querySelectorAll(a.triggers),
        s.triggers.length
    }
      , r = function() {
        return s.elements = document.querySelectorAll(a.elements),
        s.elements.length
    }
      , o = function() {
      ...
      , T = function t(n, e) {
        var i;
        for (var r in e)
            "object" !== _typeof(e[r]) || e[r]instanceof Date ? e[r]instanceof Date ? n[r] = new Date(e[r].getTime()) : n[r] = e[r] : (i = e[r]instanceof Array ? [] : {},
            void 0 === n[r] && (n[r] = i),
            t(n[r], e[r]))
    };
    return function() {
        ...
        r() && i()) {
            ...
            var t = e();
            window.addEventListener("resize", function() {
                window.innerWidth < 1366 && "desktop" === t ? (v(),
                a.animation.type = "static",
                d(),
                g()) : 1366 <= window.innerWidth && "mobile" === t && (v(),
                a.animation.type = s.animationType,
                d(),
                g()),
                t = e()
            })
...
function XM_Tooltip(t) {
    var W = {
      ...
      , i = function() {
        ...
        t.forEach(function(t) {
            ...
            if ("title" === W.type) {
                ...
                (W.type = "html") && (e.innerHTML = W.htmlContent);
      ...
      , e = function() {
        ...
        try {
            for (var a, n = h.tooltips[Symbol.iterator](); !(t = (a = n.next()).done); t = !0) {
                ...
                "center" === W.align ? "top" === W.direction || "bottom" === W.direction ? (o.tooltipWrap.item.style.left = "50%",
      ...
      , a = function() {
        ...
        try {
            for (var a, n = function() {
                ...
                t.tooltipWrap.item.style.transform = "scale(0)") : "translate-in" === W.animation.type ? (t.tooltipWrap.item.style.visibility = "hidden",
                ...
                "top" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.tooltipWrap.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.tooltipWrap.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)"))) : "translate-out-fade" === W.animation.type && (t.tooltipWrap.item.style.opacity = 0,
                t.tooltipWrap.item.style.visibility = "hidden",
                "top" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.tooltipWrap.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.tooltipWrap.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)"))),
                window.setTimeout(function() {
                    t.tooltipWrap.item.style.transition = "all ".concat(W.animation.speed, "s ").concat(W.animation.ease)
                }, 300)
            }, o = h.tooltips[Symbol.iterator](); !(t = (a = o.next()).done); t = !0)
                n()
        } catch (t) {
            i = !0,
            e = t
      ...
      , n = function() {
        if ("hover" === W.eventHandler) {
            ...
            try {
                ...
                }, c = h.tooltips[Symbol.iterator](); !(r = (m = c.next()).done); r = !0)
                    p()
            } catch (t) {
                l = !0,
                s = t
            ...
            try {
                ...
                }, b = h.tooltips[Symbol.iterator](); !(f = (v = b.next()).done); f = !0)
                    u()
            } catch (t) {
                y = !0,
                d = t
      ...
      , O = function(t) {
        ...
        t.item.style.transform = "scale(1)") : "translate-in" === W.animation.type || "translate-out" === W.animation.type ? (t.item.style.visibility = "visible",
      ...
      , w = function(t) {
        ...
        t.item.style.transform = "scale(0)") : "translate-in" === W.animation.type ? (t.item.style.visibility = "hidden",
        ...
        "top" === W.direction ? t.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)"))) : "translate-out-fade" === W.animation.type && (t.item.style.opacity = 0,
        t.item.style.visibility = "hidden",
        "top" === W.direction ? t.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)"))),
        window.setTimeout(function() {
            t.visible = !1
        }, W.animation.speed)
    }
      , o = function(t, i, e) {
        ...
        if (!t)
            throw a ? new Error("Can't find ".concat(i, " inside ").concat(a)) : new Error("Can't find ".concat(i, " in the DOM"))
    };
    (function t(i, e) {
        var a;
        for (var n in e)
            "object" !== _typeof(e[n]) || e[n]instanceof Date ? e[n]instanceof Date ? i[n] = new Date(e[n].getTime()) : i[n] = e[n] : (a = e[n]instanceof Array ? [] : {},
            void 0 === i[n] && (i[n] = a),
            t(i[n], e[n]))
    }
    )(W, t),
...
!function a(o, s, l) {
        ...
        r = function(i) {
            ...
            var e, d = {
                ...
                o.rgb.hsl = function(e) {
                    ...
                    n = (o + s) / 2,
                    [t, 100 * (s === o ? 0 : n <= .5 ? l / (s + o) : l / (2 - s - o)), 100 * n]
                }
                ,
                o.rgb.hsv = function(e) {
                    ...
                    return 0 == u ? a = o = 0 : (o = u / d,
                    n = t(s),
                    i = t(l),
                    r = t(c),
                    s === d ? a = r - i : l === d ? a = 1 / 3 + n - r : c === d && (a = 2 / 3 + i - n),
                    a < 0 ? a += 1 : 1 < a && (a -= 1)),
                    [360 * a, 100 * o, 100 * d]
                }
                ,
                    ...
                    for (var o in d)
                        if (d.hasOwnProperty(o)) {
                            var s = d[o]
                              , l = (i = e,
                            r = s,
                            Math.pow(i[0] - r[0], 2) + Math.pow(i[1] - r[1], 2) + Math.pow(i[2] - r[2], 2));
                            l < a && (a = l,
                            n = o)
                        }
                    return n
                ...
                o.hsl.hsv = function(e) {
                    ...
                    r *= a <= 1 ? a : 2 - a,
                    [t, 100 * (0 === i ? 2 * r / (a + r) : 2 * n / (i + n)), 100 * ((i + n) / 2)]
                }
                ,
                ...
                o.hsv.hsl = function(e) {
                    ...
                    return i = (2 - a) * o,
                    n = a * s,
                    [r, 100 * (n = (n /= (t = (2 - a) * s) <= 1 ? t : 2 - t) || 0), 100 * (i /= 2)]
                }
                ,
                ...
                o.xyz.lab = function(e) {
                    ...
                    return n /= 100,
                    i /= 108.883,
                    t = .008856 < (t /= 95.047) ? Math.pow(t, 1 / 3) : 7.787 * t + 16 / 116,
                ...
                o.lab.xyz = function(e) {
                    ...
                    var a = Math.pow(n, 3)
                      , o = Math.pow(t, 3)
                      , s = Math.pow(i, 3);
                    return n = .008856 < a ? a : (n - 16 / 116) / 7.787,
                    t = .008856 < o ? o : (t - 16 / 116) / 7.787,
                    i = .008856 < s ? s : (i - 16 / 116) / 7.787,
                    [t *= 95.047, n *= 100, i *= 108.883]
                }
                ,
                o.lab.lch = function(e) {
                    var t, n = e[0], i = e[1], r = e[2];
                    return (t = 360 * Math.atan2(r, i) / 2 / Math.PI) < 0 && (t += 360),
                ...
                o.hcg.rgb = function(e) {
                    ...
                    return r = (1 - n) * i,
                    [255 * (n * a[0] + r), 255 * (n * a[1] + r), 255 * (n * a[2] + r)]
                }
                ,
            ...
            function s(e) {
                var t = function() {
                    for (var e = {}, t = Object.keys(c), n = t.length, i = 0; i < n; i++)
                        e[t[i]] = {
                            distance: -1,
                            parent: null
                        };
            ...
            function l(e, t) {
                for (var n = [t[e].parent, e], i = c[t[e].parent][e], r = t[e].parent; t[r].parent; )
                    n.unshift(t[r].parent),
                    i = a(c[t[r].parent][r], i),
                    r = t[r].parent;
            ...
            Object.keys(c).forEach(function(n) {
                r[n] = {},
                Object.defineProperty(r[n], "channels", {
                    value: c[n].channels
                }),
                ...
                Object.keys(i).forEach(function(e) {
                    ...
                    r[n][e] = function(r) {
                        ...
                        return "conversion"in r && (e.conversion = r.conversion),
                        e
                    }(t),
            ...
            for (var x in o)
                t[o[x]] = x;
            var M = function(e) {
                return e instanceof M ? e : this instanceof M ? (this.valid = !1,
                this.values = {
                    rgb: [0, 0, 0],
                    hsl: [0, 0, 0],
                    hsv: [0, 0, 0],
            ...
            M.prototype = {
                ...
                clone: function() {
                    ...
                    for (var a in i)
                        ...
                        "[object Array]" === (t = {}.toString.call(e)) ? r[a] = e.slice(0) : "[object Number]" === t ? r[a] = e : console.error("unexpected color value:", e));
                    return n
                }
            },
            M.prototype.spaces = {
            ...
            M.prototype.setValues = function(e, t) {
                ...
                if (r.alpha = Math.max(0, Math.min(1, void 0 === s ? r.alpha : s)),
                "alpha" === e)
                    return !1;
                for (n = 0; n < e.length; n++)
            ...
            M.prototype.setChannel = function(e, t, n) {
                var i = this.values[e];
                return void 0 === n ? i[t] : (n === i[t] || (i[t] = n,
                this.setValues(e, i)),
                this)
            }
            ,
            ...
            var w, _ = M, S = {
                ...
                clone: function(e) {
                    ...
                    if (S.isObject(e)) {
                        for (var t = {}, n = Object.keys(e), i = n.length, r = 0; r < i; ++r)
                            t[n[r]] = S.clone(e[n[r]]);
                        return t
                    }
                    return e
                ...
                merge: function(e, t, n) {
                    ...
                    r = 0; r < c; ++r)
                        ...
                        S.isObject(t))
                            for (s = 0,
                            o = (a = Object.keys(t)).length; s < o; ++s)
                                i(a[s], e, t, n);
                    return e
                },
              ...
              , V = {
                ...
                roundedRect: function(e, t, n, i, r, a) {
                    if (a) {
                        var o = Math.min(a, r / 2, i / 2)
                          ...
                          , d = n + r - o;
                        e.moveTo(t, l),
                        s < c && l < d ? (e.arc(s, l, o, -L, -O),
                        e.arc(c, l, o, -O, 0),
                        e.arc(c, d, o, 0, O),
                        e.arc(s, d, o, O, L)) : s < c ? (e.moveTo(s, n),
                        e.arc(c, l, o, -O, O),
                        e.arc(s, l, o, O, L + O)) : l < d ? (e.arc(s, l, o, -L, 0),
                        e.arc(s, d, o, 0, L)) : e.arc(s, l, o, -L, L),
                        e.closePath(),
                        e.moveTo(t, n)
                    } else
                        e.rect(t, n, i, r)
                ...
                lineTo: function(e, t, n, i) {
                    ...
                    if (r) {
                        if ("middle" === r) {
                            var a = (t.x + n.x) / 2;
                            e.lineTo(a, i ? n.y : t.y),
                            e.lineTo(a, i ? t.y : n.y)
                        } else
                            "after" === r && !i || "after" !== r && i ? e.lineTo(t.x, n.y) : e.lineTo(n.x, t.y);
                        e.lineTo(n.x, n.y)
                    } else
            ...
            var N = {
                ...
                resolve: function(e, t, n, i) {
                    ...
                    for (r = 0,
                    a = e.length; r < a; ++r)
                        if (void 0 !== (o = e[r]) && (void 0 !== t && "function" == typeof o && (o = o(t),
                        s = !1),
                        void 0 !== n && C.isArray(o) && (o = o[n],
                        s = !1),
                        void 0 !== o))
            ...
            W.extend(X.prototype, {
                ...
                pivot: function() {
                    var e = this;
                    return e._view || (e._view = W.extend({}, e._model)),
                    e._start = {},
                    e
                },
                transition: function(e) {
                    ...
                    }(i = i || (t._start = {}), r, n, e)) : (t._view = W.extend({}, n),
                    t._start = null),
                    t
                },
            ...
            var J = {
                ...
                advance: function() {
                    for (var e, t, n, i, r = this.animations, a = 0; a < r.length; )
                        ...
                        e.currentStep >= n ? (W.callback(e.onAnimationComplete, [e], t),
                        t.animating = !1,
                        r.splice(a, 1)) : ++a
                }
            }
            ...
            function te(t, e) {
                ...
                if (n) {
                    var i = n.listeners
                      , r = i.indexOf(e);
                    -1 !== r && i.splice(r, 1),
                    0 < i.length || (ee.forEach(function(e) {
                        delete t[e]
                    }),
                    delete t._chartjs)
                }
            ...
            W.extend(ne.prototype, {
                ...
                buildOrUpdateElements: function() {
                    var e = this
                      , t = e.getDataset()
                      , n = t.data || (t.data = []);
                    e._data !== n && (e._data && te(e._data, e),
                    n && Object.isExtensible(n) && function(r, e) {
                ...
                getStyle: function(e) {
                    ...
                    !1 !== (t = i && void 0 === e ? this._resolveDatasetElementOptions(i || {}) : (e = e || 0,
                ...
                _resolveDatasetElementOptions: function(e, t) {
                    ...
                    i = u.length; n < i; ++n)
                        r = u[n],
                        a = t ? "hover" + r.charAt(0).toUpperCase() + r.slice(1) : r,
                        h[r] = Q([c[a], l[a], d[a]], f);
                    return h
                },
                _resolveDataElementOptions: function(e, t) {
                    ...
                    W.isArray(h))
                        for (o = 0,
                        s = h.length; o < s; ++o)
                            f[l = h[o]] = Q([i[l], d[l], u[l]], g, t, p);
                    else
                        for (o = 0,
                        s = (a = Object.keys(h)).length; o < s; ++o)
                            f[l = a[o]] = Q([i[l], d[h[l]], d[l], u[l]], g, t, p);
                    return p.cacheable && (n._cachedDataOpts = Object.freeze(f)),
                    f
                },
                removeHoverStyle: function(e) {
                    W.merge(e._model, e.$previousStyle || {}),
                ...
                _setDatasetHoverStyle: function() {
                    ...
                    if (o) {
                        ...
                        e = 0,
                        t = (i = Object.keys(r)).length; e < t; ++e)
                            s[n = i[e]] = a[n],
                            a[n] = r[n];
                        o.$previousStyle = s
                    }
            ...
            function ae(e, t) {
                ...
                t.innerRadius > r ? (a = r / t.innerRadius,
            ...
            function oe(e, t, n) {
                ...
                i ? (e.lineWidth = 2 * t.borderWidth,
                e.lineJoin = "round") : (e.lineWidth = t.borderWidth,
                e.lineJoin = "bevel"),
                n.fullCircles && function(e, t, n, i) {
                    var r, a = n.endAngle;
                    for (i && (n.endAngle = n.startAngle + re,
                    ae(e, n),
                    n.endAngle = a,
                    n.endAngle === n.startAngle && n.fullCircles && (n.endAngle += re,
                    n.fullCircles--)),
                    e.beginPath(),
                    e.arc(n.x, n.y, n.innerRadius, n.startAngle + re, n.startAngle, !0),
                    r = 0; r < n.fullCircles; ++r)
                        e.stroke();
                    for (e.beginPath(),
                    e.arc(n.x, n.y, t.outerRadius, n.startAngle, n.startAngle + re),
                    r = 0; r < n.fullCircles; ++r)
                        e.stroke()
                }(e, t, n, i),
                i && ae(e, n),
                ...
                inRange: function(e, t) {
                    ...
                    if (n) {
                        for (var i = W.getAngleFromPoint(n, {
                            x: e,
                            y: t
                        }), r = i.angle, a = i.distance, o = n.startAngle, s = n.endAngle; s < o; )
                            s += re;
                        for (; s < r; )
                            r -= re;
                        for (; r < o; )
                    ...
                    if (s.length) {
                        if (i._loop) {
                            for (e = 0; e < s.length; ++e)
                                if (t = W.previousItem(s, e),
                                !s[e]._view.skip && t._view.skip) {
                        ...
                        e = 1; e < s.length; ++e)
                            n = s[e]._view,
                            t = -1 === d ? W.previousItem(s, e) : s[d],
                            n.skip || (d !== e - 1 && !o || -1 === d ? a.moveTo(n.x, n.y) : W.canvas.lineTo(a, t._view, n),
                            d = e);
                        u && a.closePath(),
                        a.stroke(),
                        a.restore()
            ...
            var ge = $.extend({
                ...
                draw: function(e) {
                    ...
                    n.lineWidth = ue(t.borderWidth, l.elements.point.borderWidth),
            ...
            function me(e) {
                var t, n, i, r, a;
                return r = ve(e) ? (a = e.width / 2,
                t = e.x - a,
                n = e.x + a,
                i = Math.min(e.y, e.base),
                Math.max(e.y, e.base)) : (a = e.height / 2,
            ...
            function Ae(e, t, n) {
                var i, r, a = n.barThickness, o = t.stackCount, s = t.pixels[e], l = W.isNullOrUndef(a) ? function(e, t) {
                    ...
                    for (r = 0,
                    a = e.getTicks().length; r < a; ++r)
                        i = e.getPixelForTick(r),
                        o = 0 < r ? Math.min(o, Math.abs(i - n)) : o,
                        n = i;
                    return o
                }(t.scale, t.pixels) : -1;
                return r = W.isNullOrUndef(a) ? (i = l * n.categoryPercentage,
                n.barPercentage) : (i = a * o,
                1),
                {
                    chunk: i / o,
                    ratio: r,
            ...
            var Ee = ie.extend({
                ...
                _updateElementGeometry: function(e, t, n, i) {
                    ...
                    a.horizontal = l,
                    a.base = n ? s : d.base,
                    a.x = l ? n ? s : d.head : u.center,
                    a.y = l ? u.center : n ? s : d.head,
                    a.height = l ? u.size : void 0,
                    a.width = l ? void 0 : u.size
                },
                _getStacks: function(e) {
                    var t, n, i = this._getIndexScale(), r = i._getMatchingVisibleMetas(this._type), a = i.options.stacked, o = r.length, s = [];
                    for (t = 0; t < o && (n = r[t],
                    (!1 === a || -1 === s.indexOf(n.stack) || void 0 === a && void 0 === n.stack) && s.push(n.stack),
                    n.index !== e); ++t)
                        ;
                    return s
                },
                ...
                calculateBarValuePixels: function(e, t, n) {
                    ...
                    if (m || void 0 === m && void 0 !== y)
                        for (i = 0; i < M && (r = g[i]).index !== e; ++i)
                            r.stack === y && (a = void 0 === (c = u._parseValue(f[r.index].data[t])).start ? c.end : 0 <= c.min && 0 <= c.max ? c.max : c.min,
                            (p.min < 0 && a < 0 || 0 <= p.max && 0 < a) && (b += a));
                    return o = u.getPixelForValue(b),
                ...
                calculateBarIndexPixels: function(e, t, n, i) {
                    var r = "flex" === i.barThickness ? function(e, t, n) {
                        ...
                        return null === o && (o = a - (null === s ? t.end - t.start : s - a)),
                        null === s && (s = a + a - o),
                ...
                _resolveDataElementOptions: function() {
                    ...
                    return e.barPercentage = Le(t.barPercentage, e.barPercentage),
            ...
            var De = ie.extend({
                ...
                _resolveDataElementOptions: function(e, t) {
                    ...
                    return n._cachedDataOpts === s && (s = W.extend({}, s)),
                    s.radius = Pe([a.radius, o.r, n._config.radius, i.options.elements.point.radius], l, t),
                    s
                }
            })
              , Ve = W.valueOrDefault
                ...
                legendCallback: function(e) {
                    ...
                    o.length)
                        for (n = o[t = 0].data.length; t < n; ++t)
                            (i = r.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = o[0].backgroundColor[t],
                ...
                legend: {
                    ...
                    onClick: function(e, t) {
                        ...
                        i = (o.data.datasets || []).length; n < i; ++n)
                            (r = o.getDatasetMeta(n)).data[a] && (r.data[a].hidden = !r.data[a].hidden);
                        o.update()
                    }
                },
                cutoutPercentage: 50,
                    ...
                    callbacks: {
                        ...
                        label: function(e, t) {
                            var n = t.labels[e.index]
                              , i = ": " + t.datasets[e.datasetIndex].data[e.index];
                            return W.isArray(n) ? (n = n.slice())[0] += i : n += i,
                            n
                        }
                    }
                }
            ...
            var Ye = ie.extend({
                ...
                update: function(e) {
                    ...
                    for (i._xScale = i.getScaleForId(r.xAxisID),
                    ...
                    for (c && 0 !== a._model.tension && i.updateBezierControlPoints(),
                    t = 0,
                    n = o.length; t < n; ++t)
                        o[t].pivot()
                },
                ...
                calculatePointY: function(e, t, n) {
                    ...
                    if (u.options.stacked) {
                        for (s = +u.getRightValue(e),
                        c = (l = d._getSortedVisibleDatasetMetas()).length,
                        i = 0; i < c && (a = l[i]).index !== n; ++i)
                            r = d.data.datasets[a.index],
                            "line" === a.type && a.yAxisID === u.id && ((o = +u.getRightValue(r.data[t])) < 0 ? f += o || 0 : h += o || 0);
                ...
                updateBezierControlPoints: function() {
                    ...
                    if (r.options.elements.line.capBezierPoints)
                        ...
                        t = l.length; e < t; ++e)
                            ...
                            e < l.length - 1 && We(l[e + 1]._model, s) && (n.controlPointNextX = c(n.controlPointNextX, s.left, s.right),
                ...
                draw: function() {
                    ...
                    for (this._showLine && (e = n.dataset._model.clip,
                    ...
                    n.dataset.draw(),
                    W.canvas.unclipArea(t.ctx)); o < s; ++o)
                        i[o].draw(r)
                },
                setHoverStyle: function(e) {
                    var t = e._model
            ...
            var Ue = ie.extend({
                ...
                update: function(e) {
                    ...
                    t = 0,
                    n = a.data.length; t < n; t++)
                        l[t] = s,
                        i = r._computeAngle(t),
                        s += c[t] = i;
                    for (t = 0,
                    n = d.length; t < n; ++t)
                        d[t]._options = r._resolveDataElementOptions(d[t], t),
            ...
            var $e = ie.extend({
                ...
                _resolveDatasetElementOptions: function() {
                    ...
                    return n.spanGaps = Xe(e.spanGaps, t.spanGaps),
                    n.tension = Xe(e.lineTension, t.elements.line.tension),
                    n
                },
                updateBezierControlPoints: function() {
            ...
            function Je(e, t) {
                ...
                a = l.length; i < a; ++i)
                    for (r = 0,
                    o = (n = l[i].data).length; r < o; ++r)
                        (s = n[r])._view.skip || t(s)
            }
            function Qe(e, t) {
                var n = [];
            ...
            var it = {
                modes: {
                    ...
                    dataset: function(e, t, n) {
                        ...
                        var r = tt(n.axis)
                          , a = n.intersect ? Qe(e, i) : et(e, i, !1, r);
                        return 0 < a.length && (a = e.getDatasetMeta(a[0]._datasetIndex).data),
                        a
                    },
                    "x-axis": function(e, t) {
                        return nt(e, t, {
            ...
            function lt(e, t, n) {
                ...
                if (i = t.outerWidth - st(o, e, "left", "right"),
                r = t.outerHeight - st(o, e, "top", "bottom"),
                i !== e.w || r !== e.h)
                    return e.w = i,
                    e.h = r,
                    n.horizontal ? i !== e.w : r !== e.h
            }
            function ct(e, n) {
                var i = n.maxPadding;
                function t(e) {
            ...
            function dt(e, t, n) {
                ...
                for (i = 0,
                r = e.length; i < r; ++i)
                    (o = (a = e[i]).box).update(a.width || t.w, a.height || t.h, ct(a.horizontal, t)),
                    lt(t, n, a) && (l = !0,
                    c.length && (s = !0)),
            ...
            function ut(e, t, n) {
                ...
                r = e.length; i < r; ++i)
                    o = (a = e[i]).box,
                    a.horizontal ? (o.left = o.fullWidth ? s.left : t.left,
                    o.right = o.fullWidth ? n.outerWidth - s.right : t.left + t.w,
                    o.top = c,
                    o.bottom = c + o.height,
            ...
            var ht, ft = {
                ...
                configure: function(e, t, n) {
                    for (var i, r = ["fullWidth", "position", "weight"], a = r.length, o = 0; o < a; ++o)
                        i = r[o],
                  ...
                  , t = a.resizer = function(e) {
                    ...
                    if (a.resizer) {
                        var e = r.options.maintainAspectRatio && n.parentNode
                          , t = e ? e.clientWidth : 0;
                        i(kt("resize", r)),
                        e && e.clientWidth < t && r.canvas && i(kt("resize", r))
                    }
                }));
                !function(t, n) {
                    var e = t[pt] || (t[pt] = {})
                    ...
                    if (a.resizer) {
                        var e = n.parentNode;
                        e && e !== t.parentNode && e.insertBefore(t, e.firstChild),
                        t._reset()
                    }
                })
            }
            ...
            var Dt = {
                ...
                notify: function(e, t, n) {
                    ...
                    for (i = 0; i < c; ++i)
                        if ("function" == typeof (s = (a = (r = l[i]).plugin)[t]) && ((o = [e].concat(n || [])).push(r.options),
                        !1 === s.apply(a, o)))
                            return !1;
                    return !0
                },
                descriptors: function(e) {
                    ...
                    return this._plugins.concat(n.plugins || []).forEach(function(e) {
                        if (-1 === i.indexOf(e)) {
                            var t = e.id
                              , n = a[t];
                            !1 !== n && (!0 === n && (n = W.clone(B.global.plugins[t])),
                            i.push(e),
                            r.push({
                                plugin: e,
                                options: n || {}
                ...
                tooltips: {
                    ...
                    callbacks: {
                        ...
                        label: function(e, t) {
                            var n = t.datasets[e.datasetIndex].label || "";
                            return n && (n += ": "),
                            W.isNullOrUndef(e.value) ? n += e.yLabel : n += e.value,
                            n
                        },
            ...
            function Ht(e, t) {
                return t && (W.isArray(t) ? Array.prototype.push.apply(e, t) : e.push(t)),
                e
            }
            function Nt(e) {
            ...
            var jt = $.extend({
                ...
                getBody: function(e, n) {
                    ...
                    return W.each(e, function(e) {
                        ...
                        Ht(t.before, Nt(r.beforeLabel.call(i, e, n))),
                        Ht(t.lines, r.label.call(i, e, n)),
                        Ht(t.after, Nt(r.afterLabel.call(i, e, n))),
                        a.push(t)
                    }),
                    a
                },
                ...
                update: function(e) {
                    ...
                    if (p.length) {
                        ...
                        W.each(_, function(e) {
                            M.push(h.callbacks.labelColor.call(u, e, u._chart)),
                            w.push(h.callbacks.labelTextColor.call(u, e, u._chart))
                        }),
                        ...
                        y = function(e, t, n, i) {
                            ...
                            var f = 0;
                            return n.font = W.fontString(c, t._titleFontStyle, t._titleFontFamily),
                            W.each(t.title, h),
                ...
                getCaretPosition: function(e, t, n) {
                    ...
                    if ("center" === h)
                        ...
                        o = s - c,
                        s + c);
                    else if (a = (i = "left" === u ? (r = f + d + c) - c : "right" === u ? (r = f + p - d - c) - c : (r = n.caretX) - c,
                    r + c),
                    "top" === h)
                        s = (o = g) - c,
                        l = o;
                ...
                drawTitle: function(e, t, n) {
                    ...
                    if (s) {
                        ...
                        a = 0; a < s; ++a)
                            n.fillText(o[a], l.x(e.x), e.y + i / 2),
                            e.y += i + r,
                            a + 1 === s && (e.y += t.titleMarginBottom - r)
                    }
                },
                ...
                drawFooter: function(e, t, n) {
                    ...
                    if (o) {
                        ...
                        r = 0; r < o; ++r)
                            n.fillText(a[r], s.x(e.x), e.y + i / 2),
                ...
                draw: function() {
                    ...
                    if (0 !== t.opacity) {
                        ...
                        this._options.enabled && a && (e.save(),
                        e.globalAlpha = r,
                ...
                handleEvent: function(e) {
                    ...
                    "mouseout" === e.type ? n._active = [] : (n._active = n._chart.getElementsAtEventForMode(e, i.mode, i),
                    i.reverse && n._active.reverse()),
                    (t = !W.arrayEquals(n._active, n._lastActive)) && (n._lastActive = n._active,
            ...
            W.extend(Jt.prototype, {
                construct: function(e, t) {
                    ...
                    t = function(e) {
                        ...
                        t.labels = t.labels || [],
                        e.options = Xt(B.global, B[e.type], e.options || {}),
                        e
                    }(t);
                ...
                initialize: function() {
                    var e = this;
                    return Dt.notify(e, "beforeInit"),
                    W.retinaScale(e, e.options.devicePixelRatio),
                    e.bindEvents(),
                    e.options.responsive && e.resize(!0),
                    e.initToolTip(),
                    Dt.notify(e, "afterInit"),
                    e
                },
                clear: function() {
                    return W.canvas.clear(this),
                    this
                },
                stop: function() {
                ...
                resize: function(e) {
                    ...
                    if ((t.width !== a || t.height !== o) && (i.width = t.width = a,
                    i.height = t.height = o,
                    i.style.width = a + "px",
                    i.style.height = o + "px",
                    W.retinaScale(t, n.devicePixelRatio),
                    !e)) {
                        var s = {
                            width: a,
                            height: o
                        };
                        Dt.notify(t, "resize", [s]),
                ...
                buildOrUpdateScales: function() {
                    ...
                    W.each(t, function(e) {
                        var t = e.options
                          , n = t.id
                          , i = Ut(t.type, e.dtype);
                        Zt(t.position) !== Zt(e.dposition) && (t.position = e.dposition),
                        l[n] = !0;
                        var r = null;
                ...
                buildOrUpdateControllers: function() {
                    ...
                    t = r.length; e < t; e++) {
                        ...
                        if (o.type && o.type !== s && (n.destroyDatasetMeta(e),
                        o = n.getDatasetMeta(e)),
                        o.type = s,
                        o.order = a.order || 0,
                        o.index = e,
                        o.controller)
                            o.controller.updateIndex(e),
                            o.controller.linkScales();
                        else {
                            var l = Ze[o.type];
                            if (void 0 === l)
                                throw new Error('"' + o.type + '" is not a chart type.');
                            o.controller = new l(n,e),
                            i.push(o.controller)
                        }
                    }
                    return i
                ...
                update: function(e) {
                    ...
                    function(t) {
                        ...
                        e = Xt(B.global, B[t.config.type], e),
                    ...
                    !1 !== Dt.notify(i, "beforeUpdate")) {
                        ...
                        for (t = 0,
                        n = i.data.datasets.length; t < n; t++)
                            i.getDatasetMeta(t).controller.buildOrUpdateElements();
                        i.updateLayout(),
                        i.options.animation && i.options.animation.duration && W.each(r, function(e) {
                            e.reset()
                        }),
                        i.updateDatasets(),
                ...
                render: function(e) {
                    ...
                    if (!1 !== Dt.notify(t, "beforeRender")) {
                        var a = function(e) {
                            Dt.notify(t, "afterRender"),
                            W.callback(n && n.onComplete, [e], t)
                        };
                        if (n && i) {
                            var o = new K({
                                numSteps: i / 16.66,
                ...
                draw: function(e) {
                    var t, n, i = this;
                    if (i.clear(),
                    W.isNullOrUndef(e) && (e = 1),
                    i.transition(e),
                    !(i.width <= 0 || i.height <= 0) && !1 !== Dt.notify(i, "beforeDraw", [e])) {
                        for (n = i._layers,
                        t = 0; t < n.length && n[t].z <= 0; ++t)
                            n[t].draw(i.chartArea);
                        for (i.drawDatasets(e); t < n.length; ++t)
                            n[t].draw(i.chartArea);
                        i._drawTooltip(e),
                        Dt.notify(i, "afterDraw", [e])
                    }
                },
                transition: function(e) {
                ...
                _getSortedDatasetMetas: function(e) {
                    ...
                    n = (this.data.datasets || []).length; t < n; ++t)
                        e && !this.isDatasetVisible(t) || i.push(this.getDatasetMeta(t));
                    return i.sort(Kt("order", "index")),
                    i
                },
                ...
                drawDatasets: function(e) {
                    ...
                    if (!1 !== Dt.notify(this, "beforeDatasetsDraw", [e])) {
                        for (n = (t = this._getSortedVisibleDatasetMetas()).length - 1; 0 <= n; --n)
                ...
                drawDataset: function(e, t) {
                    ...
                    !1 !== Dt.notify(this, "beforeDatasetDraw", [n]) && (e.controller.draw(t),
                    Dt.notify(this, "afterDatasetDraw", [n]))
                },
                _drawTooltip: function(e) {
                    ...
                    !1 !== Dt.notify(this, "beforeTooltipDraw", [n]) && (t.draw(),
                    Dt.notify(this, "afterTooltipDraw", [n]))
                },
                ...
                destroy: function() {
                    ...
                    i && (n.unbindEvents(),
                    W.canvas.clear(n),
                    Pt.releaseContext(n.ctx),
                    n.canvas = null,
                    n.ctx = null),
                    Dt.notify(n, "destroy"),
                    delete Jt.instances[n.id]
                },
                ...
                updateHoverStyle: function(e, t, n) {
                    ...
                    for (r = 0,
                    a = e.length; r < a; ++r)
                        (i = e[r]) && this.getDatasetMeta(i._datasetIndex).controller[o + "HoverStyle"](i);
                ...
                eventHandler: function(e) {
                    ...
                    if (!1 !== Dt.notify(t, "beforeEvent", [e])) {
                        ...
                        Dt.notify(t, "afterEvent", [e]);
                        var r = t._bufferedRequest;
                        return r ? t.render(r) : i && !t.animating && (t.stop(),
                        t.render({
                ...
                for (r = 0; r < m; ++r) {
                    ...
                    on(s) || an(s)) {
                        if (an(s))
                            ...
                            o = s.length; a < o; ++a)
                                g = s[a],
                                on(g) || an(g) || (h = W.measureText(e, d.data, d.gc, h, g),
                                f += u)
                    } else
                        h = W.measureText(e, d.data, d.gc, h, s),
                        f = u;
                    y.push(h),
                    b.push(f),
                    x.push(u / 2)
            ...
            function hn(e) {
                var t, n;
                return e.display ? (t = W.options._parseFont(e),
                n = W.options.toPadding(e.padding),
            ...
            function vn(e, t, n, i) {
                ...
                for (a = Math.max(l, 0); a < c; a++)
                    ...
                    a === s ? (o._index = a,
                    d++,
                    s = Math.round(l + d * t)) : delete o.label
            }
            B._set("scale", {
                display: !0,
                position: "left",
            ...
            var mn = $.extend({
                ...
                update: function(e, t, n) {
                    ...
                    (!(o = l.afterBuildTicks(o) || o) || !o.length) && l.ticks)
                        for (o = [],
                        i = 0,
                        r = l.ticks.length; i < r; ++i)
                            o.push({
                                value: l.ticks[i],
                                major: !1
                            });
                    return s = d < (l._ticks = o).length,
                    a = l._convertTicksToLabels(s ? function(e, t) {
                        for (var n = [], i = e.length / t, r = 0, a = e.length; r < a; r += i)
                ...
                fit: function() {
                    var e = this
                      ...
                      , l = "bottom" === i.position
                      , c = e.isHorizontal();
                    if (c ? t.width = e.maxWidth : s && (t.width = un(o) + hn(a)),
                    c ? s && (t.height = un(o) + hn(a)) : t.height = e.maxHeight,
                    r.display && s) {
                        var d = gn(r)
                          , u = e._getLabelSizes()
                          , h = u.first
                        ...
                        if (c) {
                            ...
                            S = y ? (_ = l ? x * h.width + M * h.offset : M * (h.height - h.offset),
                            l ? M * (f.height - f.offset) : x * f.width + M * f.offset) : (_ = h.width / 2,
                            f.width / 2),
                            ...
                            t.width = Math.min(e.maxWidth, t.width + T),
                ...
                _parseValue: function(e) {
                    var t, n, i, r;
                    return r = an(e) ? (t = +this.getRightValue(e[0]),
                    n = +this.getRightValue(e[1]),
                    i = Math.min(t, n),
                    Math.max(t, n)) : (t = void 0,
                    i = n = e = +this.getRightValue(e)),
                    {
                        min: i,
                        max: r,
                        start: t,
                ...
                _autoSkip: function(e) {
                    ...
                    if (i = function(e, t, n, i) {
                        ...
                        if (!l)
                            return Math.max(c, 1);
                        for (o = 0,
                        s = (r = W.math._factorize(l)).length - 1; o < s; o++)
                            if (c < (a = r[o]))
                                return a;
                        return Math.max(c, 1)
                    }(l, e, 0, s),
                    0 < c) {
                        ...
                        n = c - 1; t < n; t++)
                            vn(e, i, l[t], l[t + 1]);
                        return r = 1 < c ? (u - d) / (c - 1) : null,
                        vn(e, i, W.isNullOrUndef(r) ? 0 : d - r, d),
                        vn(e, i, u, W.isNullOrUndef(r) ? e.length : u + r),
                        pn(e)
                    }
                    return vn(e, i),
                    pn(e)
                ...
                _isVisible: function() {
                    ...
                    if ("auto" !== r)
                        return !!r;
                    for (e = 0,
                    t = i.data.datasets.length; e < t; ++e)
                ...
                _computeGridLineItems: function(e) {
                    ...
                    for ("top" === _ ? (n = t(b.bottom),
                    l = b.bottom - L,
                    d = n - O,
                    h = t(e.top) + O,
                    g = e.bottom) : "bottom" === _ ? (n = t(b.top),
                    h = e.top,
                    g = t(e.bottom) - O,
                    l = n + O,
                    d = b.top + L) : "left" === _ ? (n = t(b.right),
                    s = b.right - L,
                    c = n - O,
                    u = t(e.left) + O,
                    f = e.right) : (n = t(b.left),
                    u = e.left,
                    f = t(e.right) - O,
                    s = n + O,
                    c = b.left + L),
                    i = 0; i < T; ++i)
                        r = k[i] || {},
                        on(r.label) && i < k.length || (y = i === b.zeroLineIndex && M.offset === S ? (p = w.zeroLineWidth,
                        v = w.zeroLineColor,
                        m = w.zeroLineBorderDash || [],
                        w.zeroLineBorderDashOffset || 0) : (p = ln(w.lineWidth, i, 1),
                        v = ln(w.color, i, "rgba(0,0,0,0.1)"),
                        m = w.borderDash || [],
                        w.borderDashOffset || 0),
                        void 0 !== (a = cn(b, r._index || i, S)) && (o = P(x, a, p),
                ...
                _computeLabelItems: function() {
                    ...
                    for (o = "top" === p ? (a = h.bottom - M - x,
                    w ? "left" : "center") : "bottom" === p ? (a = h.top + M + x,
                    w ? "right" : "center") : "left" === p ? (r = h.right - (v ? 0 : M) - x,
                    v ? "left" : "right") : (r = h.left + (v ? 0 : M) + x,
                    v ? "right" : "left"),
                    e = 0,
                    t = y.length; e < t; ++e)
                        i = (n = y[e]).label,
                        on(i) || (s = h.getPixelForTick(n._index || e) + g.labelOffset,
                        c = (l = n.major ? b.major : b.minor).lineHeight,
                        d = an(i) ? i.length : 1,
                        u = m ? (r = s,
                        "top" === p ? ((w ? 1 : .5) - d) * c : (w ? 0 : .5) * c) : (a = s,
                        (1 - d) * c / 2),
                        _.push({
                            x: r,
                            y: a,
                ...
                _drawGrid: function(e) {
                    ...
                    if (n.display) {
                        ...
                        if (u) {
                            ...
                            t.isHorizontal() ? (f = d(c, t.left, m) - m / 2,
                            g = d(c, t.right, y) + y / 2,
                            p = v = b) : (p = d(c, t.top, m) - m / 2,
                            v = d(c, t.bottom, y) + y / 2,
                            f = g = b),
                            l.lineWidth = u,
                ...
                _drawTitle: function() {
                    ...
                    if (i.display) {
                        ...
                        if (e.isHorizontal())
                            r = e.left + e.width / 2,
                            a = "bottom" === d ? e.bottom - c - l.bottom : e.top + c + l.top;
                        else {
                            var h = "left" === d;
                            r = h ? e.left + c + l.top : e.right - c - l.top,
                            a = e.top + e.height / 2,
                            u = h ? -.5 * Math.PI : .5 * Math.PI
                        }
                        t.save(),
                        t.translate(r, a),
                        t.rotate(u),
            ...
            var yn = mn
              ...
              , xn = yn.extend({
                determineDataLimits: function() {
                    ...
                    void 0 !== r && 0 <= (e = n.indexOf(r)) && (o = e),
                    void 0 !== a && 0 <= (e = n.indexOf(a)) && (s = e),
                    t.minIndex = o,
                    t.maxIndex = s,
                    t.min = n[o],
                    t.max = n[s]
                ...
                getPixelForValue: function(e, t, n) {
                    var i, r, a, o = this;
                    return bn(t) || bn(n) || (e = o.chart.data.datasets[n].data[t]),
                    bn(e) || (i = o.isHorizontal() ? e.x : e.y),
                    (void 0 !== i || void 0 !== e && isNaN(t)) && (r = o._getLabels(),
                    e = W.valueOrDefault(i, e),
                    t = -1 !== (a = r.indexOf(e)) ? a : t,
                    isNaN(t) && (t = e)),
            ...
            var Sn = yn.extend({
                ...
                buildTicks: function() {
                    var e = this
                      ...
                      , r = e.ticks = function(e, t) {
                        ...
                        if (p < 1e-14 && _n(d) && _n(u))
                            return [f, g];
                        c < (a = Math.ceil(g / p) - Math.floor(f / p)) && (p = W.niceNum(a * p / c / l) * l),
                        s || _n(h) ? n = Math.pow(10, W._decimalPlaces(p)) : (n = Math.pow(10, h),
                        p = Math.ceil(p * n) / n),
                        i = Math.floor(f / p) * p,
                        r = Math.ceil(g / p) * p,
                        s && (!_n(d) && W.almostWhole(d / p, p / 1e3) && (i = d),
                        !_n(u) && W.almostWhole(u / p, p / 1e3) && (r = u)),
                        a = (r - i) / p,
                        ...
                        o.push(_n(d) ? i : d);
                        for (var v = 1; v < a; ++v)
                            o.push(Math.round((i + v * p) * n) / n);
                        return o.push(_n(u) ? r : u),
                        o
                    }(i, e);
                ...
                _configure: function() {
                    ...
                    t.options.offset && n.length && (i -= e = (r - i) / Math.max(n.length - 1, 1) / 2,
                    r += e),
                    t._startValue = i,
                    t._endValue = r,
                    t._valueRange = r - i
            ...
            function kn(e, t, n, i) {
                ...
                for (r = 0; r < d; ++r)
                    a = e._parseValue(i[r]),
                    isNaN(a.min) || isNaN(a.max) || n.data[r].hidden || (l[r] = l[r] || 0,
                    c[r] = c[r] || 0,
                    o.relativePoints ? l[r] = 100 : a.min < 0 || a.max < 0 ? c[r] += a.min : l[r] += a.max)
            }
            function Tn(e, t, n) {
                var i, r, a = n.length;
                for (i = 0; i < a; ++i)
                    r = e._parseValue(n[i]),
                    isNaN(r.min) || isNaN(r.max) || t.data[i].hidden || (e.min = Math.min(e.min, r.min),
            ...
            var Ln = Sn.extend({
                determineDataLimits: function() {
                    ...
                    if (r.min = Number.POSITIVE_INFINITY,
                    r.max = Number.NEGATIVE_INFINITY,
                    void 0 === l)
                        for (e = 0; !l && e < d; ++e)
                            l = void 0 !== (t = s[e]).stack;
                    for (e = 0; e < d; ++e)
                        n = o[(t = s[e]).index].data,
                        l ? kn(r, c, t, n) : Tn(r, t, n);
                    W.each(c, function(e) {
                        i = e.pos.concat(e.neg),
                        r.min = Math.min(r.min, W.min(i)),
                        r.max = Math.max(r.max, W.max(i))
                    }),
            ...
            var Vn = yn.extend({
                determineDataLimits: function() {
                    ...
                    if (void 0 === h)
                        for (e = 0; e < c.length; e++)
                            if (t = l.getDatasetMeta(e),
                            l.isDatasetVisible(e) && u(t) && void 0 !== t.stack) {
                                h = !0;
                                break
                            }
                    if (s.stacked || h) {
                        ...
                        for (e = 0; e < c.length; e++) {
                            ...
                            if (l.isDatasetVisible(e) && u(t))
                                for (void 0 === f[g] && (f[g] = []),
                                r = 0,
                                a = (i = c[e].data).length; r < a; r++) {
                                    var p = f[g];
                                    n = o._parseValue(i[r]),
                                    isNaN(n.min) || isNaN(n.max) || t.data[r].hidden || n.min < 0 || n.max < 0 || (p[r] = p[r] || 0,
                                    p[r] += n.max)
                                }
                        }
                        W.each(f, function(e) {
                        ...
                        for (e = 0; e < c.length; e++)
                            if (t = l.getDatasetMeta(e),
                            l.isDatasetVisible(e) && u(t))
                                for (r = 0,
                                a = (i = c[e].data).length; r < a; r++)
                                    n = o._parseValue(i[r]),
                                    isNaN(n.min) || isNaN(n.max) || t.data[r].hidden || n.min < 0 || n.max < 0 || (o.min = Math.min(n.min, o.min),
                                    o.max = Math.max(n.max, o.max),
                                    0 !== n.min && (o.minNotZero = Math.min(n.min, o.minNotZero)));
                    o.min = W.isFinite(o.min) ? o.min : null,
                    o.max = W.isFinite(o.max) ? o.max : null,
                    o.minNotZero = W.isFinite(o.minNotZero) ? o.minNotZero : null,
                ...
                handleTickRangeOptions: function() {
                    ...
                    e.min === e.max && (0 !== e.min && null !== e.min ? (e.min = Math.pow(10, Math.floor(On(e.min)) - 1),
                    e.max = Math.pow(10, Math.floor(On(e.max)) + 1)) : (e.min = 1,
                    e.max = 10)),
                    null === e.min && (e.min = Math.pow(10, Math.floor(On(e.max)) - 1)),
                ...
                buildTicks: function() {
                    var e = this
                      ...
                      , r = e.ticks = function(e, t) {
                        ...
                        0 === a ? (n = Math.floor(On(t.minNotZero)),
                        i = Math.floor(t.minNotZero / Math.pow(10, n)),
                        r.push(a),
                        a = i * Math.pow(10, n)) : (n = Math.floor(On(a)),
                        i = Math.floor(a / Math.pow(10, n)));
                        for (var l = n < 0 ? Math.pow(10, Math.abs(n)) : 1; r.push(a),
                        10 === ++i && (i = 1,
                        l = 0 <= ++n ? 1 : l),
                ...
                _configure: function() {
                    ...
                    n = En(e.options.ticks.fontSize, B.global.defaultFontSize) / e._length),
                    e._startValue = On(t),
                    e._valueOffset = n,
                    e._valueRange = (On(e.max) - On(t)) / (1 - n)
                },
                getPixelForValue: function(e) {
                    var t = this
                      , n = 0;
            ...
            var Yn = Sn.extend({
                    ...
                    W.each(n.data.datasets, function(e, t) {
                        if (n.isDatasetVisible(t)) {
                            ...
                            W.each(e.data, function(e, t) {
                                ...
                                isNaN(n) || i.data[t].hidden || (a = Math.min(n, a),
                                o = Math.max(n, o))
                            })
                        }
                    }),
                ...
                fit: function() {
                    ...
                    e.display && e.pointLabels.display ? function(e) {
                        ...
                        for (t = 0; t < d; t++) {
                            ...
                            f.start < a.l && (a.l = f.start,
                            o.l = u),
                            f.end > a.r && (a.r = f.end,
                            o.r = u),
                            g.start < a.t && (a.t = g.start,
                            o.t = u),
                            g.end > a.b && (a.b = g.end,
                            o.b = u)
                        }
                ...
                setReductions: function(e, t, n) {
                    ...
                    o = jn(o),
                    s = jn(s),
                    i.drawingArea = Math.min(Math.floor(e - (r + a) / 2), Math.floor(e - (o + s) / 2)),
                ...
                _drawGrid: function() {
                    ...
                    o.display && W.each(i.ticks, function(e, t) {
                        0 !== t && (n = i.getDistanceFromCenterForValue(i.ticksAsNumbers[t]),
                        function(e, t, n, i) {
                            ...
                            if ((o || s) && l && c) {
                                ...
                                a.strokeStyle = l,
                                a.lineWidth = c,
                                a.setLineDash && (a.setLineDash(t.borderDash || []),
                    ...
                    s.display && l && c) {
                        ...
                        r.lineWidth = l,
                        r.strokeStyle = c,
                        r.setLineDash && (r.setLineDash(Hn([s.borderDash, o.borderDash, []])),
                        r.lineDashOffset = Hn([s.borderDashOffset, o.borderDashOffset, 0])),
                        e = i.chart.data.labels.length - 1; 0 <= e; e--)
                            n = i.getDistanceFromCenterForValue(a.ticks.reverse ? i.min : i.max),
                            t = i.getPointPosition(e, n),
                            r.beginPath(),
                ...
                _drawLabels: function() {
                    ...
                    if (r.display) {
                        ...
                        W.each(n.ticks, function(e, t) {
                            ...
                            r.showLabelBackdrop && (o = i.measureText(e).width,
            ...
            function ii(e, t) {
                ...
                null !== o ? +o : (r || "function" != typeof a || (o = a(t),
                W.isFinite(o) || (o = n.parse(o))),
                o)
            }
            function ri(e, t) {
                ...
                return null === i || n.round && (i = +e._adapter.startOf(i, n.round)),
                i
            }
            function ai(e, t, n, i) {
                var r, a, o, s = Jn.length;
                for (r = Jn.indexOf(e); r < s - 1; ++r)
                    if (o = (a = Kn[Jn[r]]).steps ? a.steps : Zn,
            ...
            var si = yn.extend({
                ...
                update: function() {
                    ...
                    return Un("time scale", t.format, "time.format", "time.parser"),
                ...
                determineDataLimits: function() {
                    ...
                    n = m.length; e < n; ++e)
                        v.push(ri(s, m[e]));
                    for (e = 0,
                    n = (l.data.datasets || []).length; e < n; ++e)
                        if (l.isDatasetVisible(e))
                            if (r = l.data.datasets[e].data,
                            W.isObject(r[0]))
                                for (p[e] = [],
                                t = 0,
                                i = r.length; t < i; ++t)
                            ...
                            p[e] = [];
                    v.length && (h = Math.min(h, v[0]),
                    f = Math.max(f, v[v.length - 1])),
                    g.length && (g = 1 < n ? function(e) {
                        var t, n, i, r = {}, a = [];
                        for (t = 0,
                        n = e.length; t < n; ++t)
                            r[i = e[t]] || (r[i] = !0,
                ...
                buildTicks: function() {
                    ...
                    for (c = "data" === h || "auto" === h && "series" === f ? c.data : "labels" === h ? c.labels : function(e, t, n, i) {
                        ...
                        if (d && (u = +a.startOf(u, "isoWeek", d)),
                        u = +a.startOf(u, d ? "day" : l),
                        a.diff(n, t, l) > 1e5 * c)
                            throw t + " and " + n + " are too far apart with stepSize of " + c + " " + l;
                        for (r = u; r < n; r = +a.add(r, c, l))
                            h.push(r);
                        return r !== n && "ticks" !== o.bounds || h.push(r),
                        h
                    }(i, r, a, u),
                    "ticks" === o.bounds && c.length && (r = c[0],
                    a = c[c.length - 1]),
                    r = ri(i, ei(o)) || r,
                    a = ri(i, ti(o)) || a,
                    e = 0,
                    ...
                    return i.min = r,
                    i.max = a,
                    i._unit = l.unit || (s.autoSkip ? ai(l.minUnit, i.min, i.max, u) : function(e, t, n, i, r) {
                        var a, o;
                        for (a = Jn.length - 1; a >= Jn.indexOf(n); a--)
                            if (o = Jn[a],
                            Kn[o].common && e._adapter.diff(r, i, o) >= t - 1)
                                return o;
                        return Jn[n ? Jn.indexOf(n) : 0]
                    }(i, d.length, l.minUnit, i.min, i.max)),
                    i._majorUnit = s.major.enabled && "year" !== i._unit ? function(e) {
                    ...
                    i._offsets = function(e, t, n, i, r) {
                        var a, o, s = 0, l = 0;
                        return r.offset && t.length && (a = ni(e, "time", t[0], "pos"),
                ...
                getLabelForIndex: function(e, t) {
                    ...
                    return W.isObject(s) && (o = n.getRightValue(s)),
                    a.tooltipFormat ? i.format(ii(n, o), a.tooltipFormat) : "string" == typeof o ? o : i.format(ii(n, o), a.displayFormats.datetime)
                },
                ...
                getPixelForValue: function(e, t, n) {
                    var i = null;
                    if (void 0 !== t && void 0 !== n && (i = this._timestamps.datasets[n][t]),
                    null === i && (i = ri(this, e)),
                    null !== i)
            ...
            nn._date.override("function" == typeof i ? {
                ...
                startOf: function(e, t, n) {
                    return e = i(e),
                    "isoWeek" === t ? e.isoWeekday(n).valueOf() : e.startOf(t).valueOf()
                },
                endOf: function(e, t) {
            ...
            function hi(e, t, n) {
                ...
                if (void 0 === a && (a = !!r.backgroundColor),
                !1 === a || null === a)
                    return !1;
                if (!0 === a)
                    return "origin";
                if (i = parseFloat(a, 10),
                isFinite(i) && Math.floor(i) === i)
                    return "-" !== a[0] && "+" !== a[0] || (i = t + i),
                    !(i === t || i < 0 || n <= i) && i;
                switch (a) {
                case "bottom":
                    return "start";
            ...
            function vi(e, t, n, i, r) {
                ...
                if (i && r) {
                    ...
                    if (void 0 === n[0].angle)
                        for (e.lineTo(n[r - 1].x, n[r - 1].y),
                        a = r - 1; 0 < a; --a)
                            W.canvas.lineTo(e, n[a], n[a - 1], !0);
                    else
                        for (o = n[0].cx,
                        s = n[0].cy,
                        l = Math.sqrt(Math.pow(n[0].x - o, 2) + Math.pow(n[0].y - s, 2)),
                        a = r - 1; 0 < a; --a)
                            e.arc(o, s, l, n[a].angle, n[a - 1].angle, !0)
                }
            }
            function mi(e, t, n, i, r, a) {
                ...
                s = g; o < s; ++o)
                    ...
                    u && h ? (y = v.push(c),
                    b = m.push(d)) : y && b && (p ? (u && v.push(c),
                    h && m.push(d)) : (vi(e, v, m, y, b),
                    y = b = 0,
                    v = [],
                    m = []));
                vi(e, v, m, y, b),
            ...
            var yi = {
                ...
                afterDatasetsUpdate: function(e, t) {
                    ...
                    for (i = 0; i < c; ++i)
                        a = null,
                        (r = (n = e.getDatasetMeta(i)).dataset) && r._model && r instanceof we.Line && (a = {
                ...
                beforeDatasetsDraw: function(e) {
                    ...
                    for (n = l.length - 1; 0 <= n; --n)
                        (t = l[n].$filler) && t.visible && (r = (i = t.el)._view,
                        a = i._children || [],
                        o = t.mapper,
                        s = r.backgroundColor || B.global.defaultColor,
                        o && s && a.length && (W.canvas.clipArea(c, e.chartArea),
                        mi(c, a, o, r, s, i._loop),
            ...
            var _i = $.extend({
                ...
                fit: function() {
                    ...
                    n) {
                        ...
                        c) {
                            ...
                            W.each(e.legendItems, function(e, t) {
                                var n = wi(i, o) + o / 2 + r.measureText(e.text).width;
                                0 < t && m + o + 2 * h > l.height && (p += v + i.padding,
                                f.push(v),
                                g.push(m),
                                m = v = 0),
                                v = Math.max(v, n),
                ...
                draw: function() {
                    ...
                    if (n.display) {
                        ...
                        W.each(s.legendItems, function(e, t) {
                            ...
                            w ? 0 < t && r + i + l.padding > s.left + s.minSize.width && (a = p.y += _,
                            p.line++,
                            r = p.x = s.left + M(f, g[p.line])) : 0 < t && a + _ > s.top + s.minSize.height && (r = p.x = r + s.columnWidths[p.line] + l.padding,
                            p.line++,
                            a = p.y = s.top + M(u, h[p.line]));
                            var o = v.x(r);
                            !function(e, t, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    m.save();
                                    var i = Mi(n.lineWidth, d.borderWidth);
                                    if (m.fillStyle = Mi(n.fillStyle, c),
                                    ...
                                    l && l.usePointStyle) {
                                        ...
                                        m.fillRect(v.leftForLtr(e, b), t, b, y),
                                        0 !== i && m.strokeRect(v.leftForLtr(e, b), t, b, y);
                                    m.restore()
                                }
                            }(o, a, e),
                            ...
                            function(e, t, n, i) {
                                var r = y / 2
                                  , a = v.xPlus(e, b + r)
                                  , o = t + r;
                                m.fillText(n.text, a, o),
                                n.hidden && (m.beginPath(),
                                m.lineWidth = 2,
                                m.moveTo(a, o),
                                m.lineTo(v.xPlus(a, i), o),
                                m.stroke())
                            }(o, x[t].top = a, e, n),
                ...
                handleEvent: function(e) {
                    ...
                    "click" === i ? t && n.onClick && n.onClick.call(this, e.native, t) : (n.onLeave && t !== this._hoveredItem && (this._hoveredItem && n.onLeave.call(this, e.native, this._hoveredItem),
                    this._hoveredItem = t),
                    n.onHover && t && n.onHover.call(this, e.native, t))
                }
            });
            function Si(e, t) {
                var n = new _i({
            ...
            var Ci = {
                ...
                beforeUpdate: function(e) {
                    var t = e.options.legend
                      , n = e.legend;
                    t ? (W.mergeIf(t, B.global.legend),
                    n ? (ft.configure(e, n, t),
                    n.options = t) : Si(e, t)) : n && (ft.removeBox(e, n),
                    delete e.legend)
                },
            ...
            var Ti = $.extend({
                ...
                fit: function() {
                    ...
                    this.width = n.width = i ? this.maxWidth : e,
                    this.height = n.height = i ? e : this.maxHeight) : this.width = n.width = this.height = n.height = 0
                },
                afterFit: ki,
                isHorizontal: function() {
                    var e = this.options.position;
                ...
                draw: function() {
                    ...
                    if (t.display) {
                        ...
                        e.fillStyle = W.valueOrDefault(t.fontColor, B.global.defaultFontColor),
                        e.font = a.string,
                        this.isHorizontal() ? (i = d + (h - d) / 2,
                        r = c + s,
                        n = h - d) : (i = "left" === t.position ? d + s : h - s,
                        r = c + (u - c) / 2,
                        n = u - c,
                        l = Math.PI * ("left" === t.position ? -.5 : .5)),
                        e.save(),
                        e.translate(i, r),
                        e.rotate(l),
                        e.textAlign = "center",
            ...
            var Ai = {}
              ...
              , Pi = {
                ...
                beforeUpdate: function(e) {
                    var t = e.options.title
                      , n = e.titleBlock;
                    t ? (W.mergeIf(t, B.global.title),
                    n ? (ft.configure(e, n, t),
                    n.options = t) : Li(e, t)) : n && (ft.removeBox(e, n),
                    delete e.titleBlock)
                }
            };
            function Di(e, t, n) {
                var i;
                return "string" == typeof e ? (i = parseInt(e, 10),
                -1 !== e.indexOf("%") && (i = i / 100 * t.parentNode[n])) : i = e,
                i
            }
            function Vi(e) {
            ...
            for (var zi in Ai.filler = Ei,
            Ai.legend = Oi,
            Ai.title = Pi,
            (Qt.helpers = W).where = function(e, t) {
                if (W.isArray(e) && Array.prototype.filter)
                    return e.filter(t);
                var n = [];
                return W.each(e, function(e) {
                    t(e) && n.push(e)
            ...
            W.splineCurveMonotone = function(e) {
                ...
                for (t = 0; t < u; ++t)
                    if (!(i = d[t]).model.skip) {
                        if (n = 0 < t ? d[t - 1] : null,
                        (r = t < u - 1 ? d[t + 1] : null) && !r.model.skip) {
                ...
                for (t = 0; t < u - 1; ++t)
                    i = d[t],
                    r = d[t + 1],
                    i.model.skip || r.model.skip || (W.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = r.mK = 0 : (a = i.mK / i.deltaK,
                    o = r.mK / i.deltaK,
                    (l = Math.pow(a, 2) + Math.pow(o, 2)) <= 9 || (s = 3 / Math.sqrt(l),
                    i.mK = a * s * i.deltaK,
                    r.mK = o * s * i.deltaK)));
                for (t = 0; t < u; ++t)
                    (i = d[t]).model.skip || (n = 0 < t ? d[t - 1] : null,
                    r = t < u - 1 ? d[t + 1] : null,
                    n && !n.model.skip && (c = (i.model.x - n.model.x) / 3,
                    i.model.controlPointPreviousX = i.model.x - c,
                    i.model.controlPointPreviousY = i.model.y - c * i.mK),
                    r && !r.model.skip && (c = (r.model.x - i.model.x) / 3,
            ...
            W.retinaScale = function(e, t) {
                ...
                if (1 !== n) {
                    ...
                    i.width = a * n,
                    e.ctx.scale(n, n),
                    i.style.height || i.style.width || (i.style.height = r + "px",
                    i.style.width = a + "px")
                }
            }
            ,
            ...
            W.longestText = function(e, t, n, i) {
                ...
                for (o = 0; o < h; o++)
                    if (null != (c = n[o]) && !0 !== W.isArray(c))
                        u = W.measureText(e, r, a, u, c);
                    else if (W.isArray(c))
                        for (s = 0,
                        l = c.length; s < l; s++)
                            null == (d = c[s]) || W.isArray(d) || (u = W.measureText(e, r, a, u, d));
                var f = a.length / 2;
                if (f > n.length) {
                    for (o = 0; o < f; o++)
                        delete r[a[o]];
            ...
            W.measureText = function(e, t, n, i, r) {
                var a = t[r];
                return a || (a = t[r] = e.measureText(r).width,
                n.push(r)),
                i < a && (i = a),
                i
            }
            ...
            W.color = _ ? function(e) {
                return e instanceof CanvasGradient && (e = B.global.defaultColor),
                _(e)
            }
            : function(e) {
            ...
            Ai)
                Ai.hasOwnProperty(zi) && Qt.plugins.register(Ai[zi]);
            Qt.platform.initialize();
            var Bi = Qt;
            return "undefined" != typeof window && (window.Chart = Qt),
            (Qt.Chart = Qt).Legend = Ai.legend._element,
            Qt.Title = Ai.title._element,
    ...
    2: [function($n, Zn, e) {
        ...
        n = function() {
            ...
            function v(e) {
                var t = u(NaN);
                return null != e ? d(g(t), e) : g(t).userInvalidated = !0,
                t
            }
            ...
            function n(r, a) {
                var o = !0;
                return d(function() {
                    if (null != h.deprecationHandler && h.deprecationHandler(null, r),
                    o) {
            ...
            var C, k = {};
            function T(e, t) {
                null != h.deprecationHandler && h.deprecationHandler(e, t),
                k[e] || (S(t),
                k[e] = !0)
            }
            function L(e) {
            ...
            function A(e, t) {
                var n, i = d({}, e);
                for (n in t)
                    f(t, n) && (s(e[n]) && s(t[n]) ? (i[n] = {},
                    d(i[n], e[n]),
                    d(i[n], t[n])) : null != t[n] ? i[n] = t[n] : delete i[n]);
                for (n in e)
                    f(e, n) && !f(t, n) && s(e[n]) && (i[n] = d({}, i[n]));
                return i
            }
            function E(e) {
                null != e && this.set(e)
            ...
            function j(e, t) {
                ...
                I[t] = I[t] || function(i) {
                    ...
                    for (e = 0,
                    r = a.length; e < r; e++)
                        F[a[e]] ? a[e] = F[a[e]] : a[e] = (t = a[e]).match(/\[[\s\S]/) ? t.replace(/^\[|\]$/g, "") : t.replace(/\\/g, "");
                    return function(e) {
                        var t, n = "";
                        for (t = 0; t < r; t++)
                            n += L(a[t]) ? a[t].call(e, i) : a[t];
                        return n
                    }
                }(t),
            ...
            function Fe(e, t, n, i, r) {
                ...
                return o = s <= 0 ? _e(a = e - 1) + s : s > _e(e) ? (a = e + 1,
                s - _e(e)) : (a = e,
                s),
                {
                    year: a,
            ...
            function dt(e) {
                ...
                return function(e) {
                    for (var t, n, i, r, a = 0; a < e.length; ) {
                        for (t = (r = ot(e[a]).split("-")).length,
                        n = (n = ot(e[a + 1])) ? n.split("-") : null; 0 < t; ) {
            ...
            function ft(e) {
                ...
                if (!e._d) {
                    ...
                    e._w && null == e._a[ve] && null == e._a[pe] && function(e) {
                        var t, n, i, r, a, o, s, l;
                        if (null != (t = e._w).GG || null != t.W || null != t.E)
                            a = 1,
                            o = 4,
                            n = ht(t.GG, e._a[ge], We(Lt(), 1, 4).year),
                            i = ht(t.W, 1),
                            ((r = ht(t.E, 1)) < 1 || 7 < r) && (l = !0);
                        else {
                            a = e._locale._week.dow,
                            o = e._locale._week.doy;
                            var c = We(Lt(), a, o);
                            n = ht(t.gg, e._a[ge], c.year),
                            i = ht(t.w, c.week),
                            null != t.d ? ((r = t.d) < 0 || 6 < r) && (l = !0) : null != t.e ? (r = t.e + a,
                            (t.e < 0 || 6 < t.e) && (l = !0)) : r = a
                        }
                    ...
                    null != e._dayOfYear && (a = ht(e._a[ge], i[ge]),
                    ...
                    e._a[me] = 0),
                    e._d = (e._useUTC ? Ne : function(e, t, n, i, r, a, o) {
                        var s;
                        return e < 100 && 0 <= e ? (s = new Date(e + 400,t,n,i,r,a,o),
                        isFinite(s.getFullYear()) && s.setFullYear(e)) : s = new Date(e,t,n,i,r,a,o),
                        s
                    }
                    ).apply(null, o),
            ...
            function Ct(e) {
                if (e._f !== h.ISO_8601)
                    if (e._f !== h.RFC_2822) {
                        ...
                        for (i = Y(e._f, e._locale).match(H) || [],
                        t = 0; t < i.length; t++)
                            r = i[t],
                            (n = (c.match(ce(r, e)) || [])[0]) && (0 < (a = c.substr(0, c.indexOf(n))).length && g(e).unusedInput.push(a),
                            c = c.slice(c.indexOf(n) + n.length),
                            u += n.length),
                            F[r] ? (n ? g(e).empty = !1 : g(e).unusedTokens.push(r),
                            o = r,
                            l = e,
                            null != (s = n) && f(ue, o) && ue[o](s, l._a, l, o)) : e._strict && !n && g(e).unusedTokens.push(r);
            ...
            function kt(e) {
                ...
                x(t) ? new b(ut(t)) : (c(t) ? e._d = t : o(n) ? function(e) {
                    var t, n, i, r, a;
                    if (0 === e._f.length)
            ...
            function Dt(e) {
                ...
                this._isValid = function(e) {
                    for (var t in e)
                        if (-1 === Ce.call(Pt, t) || null != e[t] && isNaN(e[t]))
                            return !1;
            ...
            function Nt(e, t) {
                ...
                i = (x(e) || c(e) ? e.valueOf() : Lt(e).valueOf()) - n.valueOf(),
            ...
            function Yt(e, t) {
                ...
                t ? a[t] = e : a.milliseconds = e) : (o = Wt.exec(e)) ? (n = "-" === o[1] ? -1 : 1,
                a = {
                    y: 0,
                    d: w(o[ve]) * n,
                    h: w(o[me]) * n,
            ...
            function Xt(e, t, n, i) {
                ...
                o && Ve(e, Le(e, "Month") + o * n),
                a && Ae(e, "Date", Le(e, "Date") + a * n),
                r && e._d.setTime(e._d.valueOf() + r * n),
                i && h.updateOffset(e, a || o))
            }
            Yt.fn = Dt.prototype,
            Yt.invalid = function() {
                return Yt(NaN)
            ...
            function sn(e, t, n, i, r) {
                var a;
                return null == e ? We(this, i, r).year : ((a = je(e, i, r)) < t && (t = a),
                function(e, t, n, i, r) {
                    var a = Fe(e, t, n, i, r)
            ...
            gn.set = function(e, t) {
                if ("object" == typeof e)
                    for (var n = function(e) {
                        ...
                        t
                    }(e = V(e)), i = 0; i < n.length; i++)
                        this[n[i].unit](e[n[i].unit]);
                else if (L(this[e = D(e)]))
                    return this[e](t);
                return this
            }
            ,
            ...
            gn.utcOffset = function(e, t, n) {
                ...
                return !this._isUTC && t && (i = It(this)),
                this._offset = e,
                this._isUTC = !0,
                null != i && this.add(i, "m"),
                r !== e && (!t || this._changeInProgress ? Xt(this, Yt(e - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
                h.updateOffset(this, !0),
            ...
            function bn(e, t, n, i) {
                ...
                if (null != n)
                    return mn(t, (n + o) % 7, i, "day");
                var s = [];
                for (r = 0; r < 7; r++)
                    s[r] = mn(t, (r + o) % 7, i, "day");
                return s
            }
            ...
            vn.monthsRegex = function(e) {
                ...
                e ? this._monthsStrictRegex : this._monthsRegex) : (f(this, "_monthsRegex") || (this._monthsRegex = Be),
                this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex)
            }
            ,
            vn.monthsShortRegex = function(e) {
                return this._monthsParseExact ? (f(this, "_monthsRegex") || He.call(this),
                e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = ze),
            ...
            vn.weekdaysRegex = function(e) {
                ...
                e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = Xe),
                this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex)
            }
            ,
            vn.weekdaysShortRegex = function(e) {
                return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Ke.call(this),
                e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $e),
                this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
            }
            ,
            vn.weekdaysMinRegex = function(e) {
                return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Ke.call(this),
                e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Ze),
            ...
            h.updateLocale = function(e, t) {
                if (null != t) {
                    ...
                    (n = new E(t = A(r, t))).parentLocale = rt[e],
                    rt[e] = n,
                    lt(e)
                } else
                    null != rt[e] && (null != rt[e].parentLocale ? rt[e] = rt[e].parentLocale : null != rt[e] && delete rt[e]);
                return rt[e]
            }
            ,
            h.locales = function() {
            ...
            h.relativeTimeRounding = function(e) {
                return void 0 === e ? jn : "function" == typeof e && (jn = e,
                !0)
            }
            ,
    ...
    3: [function(e, n, i) {
        (function(Fr) {
            ...
            t = function() {
                ...
                function te(c) {
                    return function(e, t, n) {
                        var i, r, a, o = d(e), s = ee(o.length), l = (r = s,
                        (a = Q(n)) < 0 ? be(a + r, 0) : xe(a, r));
                        if (c && t != t) {
                            for (; l < s; )
                                if ((i = o[l++]) != i)
                                    return !0
                ...
                function ne(e, t) {
                    var n, i = d(e), r = 0, a = [];
                    for (n in i)
                        !c(Y, n) && c(i, n) && a.push(n);
                    for (; t.length > r; )
                        c(i, n = t[r++]) && (~Me(a, n) || a.push(n));
                    return a
                }
                function ie(e, t) {
                ...
                function ae(e, t) {
                    ...
                    if (n = l ? y : c ? y[s] || u(s, {}) : (y[s] || {}).prototype)
                        for (i in t) {
                            if (a = t[i],
                            r = e.noTargetGet ? (o = De(n, i)) && o.value : n[i],
                            !Pe(l ? i : s + (c ? "." : "#") + i, e.forced) && void 0 !== r) {
                                if (typeof a == typeof r)
                                    continue;
                                ie(a, r)
                            }
                            (e.sham || r && r.sham) && z(a, "sham", !0),
                            ge(n, i, a, e)
                        }
                }
                function oe(e) {
                ...
                var fe = {
                  ...
                  , ge = t(function(e) {
                    ...
                    (e.exports = function(e, t, n, i) {
                        ...
                        s(n).source = l.join("string" == typeof t ? t : "")),
                        e !== y ? (r ? !o && e[t] && (a = !0) : delete e[t],
                ...
                var Ke = Object.keys || function(e) {
                  ...
                  , Je = b ? Object.defineProperties : function(e, t) {
                    S(e);
                    for (var n, i = Ke(t), r = i.length, a = 0; a < r; )
                        R.f(e, n = i[a++], t[n]);
                    return e
                }
                  ...
                  , nt = Object.create || function(e, t) {
                    var n;
                    return null !== e ? (Ze.prototype = S(e),
                    n = new Ze,
                    Ze.prototype = null,
                    n[et] = e) : n = tt(),
                    void 0 === t ? n : Je(n, t)
                ...
                var ot, st, lt, ct = {}, dt = !v(function() {
                    ...
                    return e = le(e),
                    c(e, ut) ? e[ut] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? ht : null
                }
                , gt = ce("iterator"), pt = !1;
                [].keys && ("next"in (lt = [].keys()) ? (st = ft(ft(lt))) !== Object.prototype && (ot = st) : pt = !0),
                null == ot && (ot = {}),
                c(ot, gt) || z(ot, gt, function() {
                    return this
                });
                function vt(e, t, n) {
                ...
                function bt(e, t, n, i, r, a, o) {
                    ...
                    if (b && (u = ft(b.call(new e)),
                    Ct !== Object.prototype && u.next && (ft(u) !== Ct && (St ? St(u, Ct) : "function" != typeof u[Tt] && z(u, Tt, yt)),
                    vt(u, g, !0))),
                    "values" == r && m && "values" !== m.name && (p = !0,
                    y = function() {
                        return m.call(this)
                    }
                    ),
                ...
                var Ot = Object.assign
                  , Pt = !Ot || v(function() {
                    ...
                    for (var n = le(e), i = arguments.length, r = 1, a = Ce.f, o = _.f; r < i; )
                        for (var s, l = T(arguments[r++]), c = a ? Ke(l).concat(a(l)) : Ke(l), d = c.length, u = 0; u < d; )
                            s = c[u++],
                  ...
                  , rn = t(function(e) {
                    ...
                    var t = R.f
                      ...
                      , o = e.exports = {
                        ...
                        onFreeze: function(e) {
                            return nn && o.REQUIRED && a(e) && !c(e, i) && n(e),
                            e
                        }
                    };
                    Y[i] = !0
                    ...
                    (e.exports = function(e, t, n, i, r) {
                        ...
                        if (r)
                            ...
                            if ("function" != typeof (o = function(e) {
                                if (null != e)
                                    return e[sn] || e["@@iterator"] || ct[Dt(e)]
                            }(e)))
                                throw TypeError("Target is not iterable");
                            if (void 0 !== (u = o) && (ct.Array === u || on[an] === u)) {
                                for (s = 0,
                                l = ee(e.length); s < l; s++)
                                    if ((c = i ? h(S(d = e[s])[0], d[1]) : h(e[s])) && c instanceof f)
                                        return c;
                                return new f(!1)
                            }
                            a = o.call(e)
                        ...
                        for (; !(d = a.next()).done; )
                            if ((c = en(a, h, d.value, i)) && c instanceof f)
                                return c;
                        return new f(!1)
                    }
                    ).stop = function(e) {
                ...
                function fn(s, e, t, l, i) {
                    ...
                    if (Pe(s, "function" != typeof c || !(i || r.forEach && !v(function() {
                        ...
                        g || (((d = e(function(e, t) {
                            tn(e, d, s);
                            var n, i, r, a, o = (n = new c,
                            i = d,
                            St && "function" == typeof (r = e.constructor) && r !== i && m(a = r.prototype) && a !== i.prototype && St(n, a),
                            n);
                            return null != t && ln(t, o[u], o, l),
                            o
                ...
                var _n = {
                    getConstructor: function(e, n, i, r) {
                        function a(e, t, n) {
                            var i = s(e)
                              , r = vn(S(t), !0);
                            return !0 === r ? gn(i).set(t, n) : r[i.id] = n,
                            e
                        }
                  ...
                  , Sn = (t(function(e) {
                    ...
                    if (I && n) {
                        i = _n.getConstructor(t, "WeakMap", !0),
                        rn.REQUIRED = !0;
                        var s = o.prototype
                          , l = s.delete
                          , c = s.has
                        ...
                        Qt(s, {
                            ...
                            get: function(e) {
                                ...
                                var t = r(this);
                                return t.frozen || (t.frozen = new i),
                                c.call(this, e) ? d.call(this, e) : t.frozen.get(e)
                            },
                            set: function(e, t) {
                                if (m(e) && !a(e)) {
                                    var n = r(this);
                                    n.frozen || (n.frozen = new i),
                                    c.call(this, e) ? u.call(this, e, t) : n.frozen.set(e, t)
                                } else
                                    u.call(this, e, t);
                                return this
                            }
                ...
                function qn(e) {
                    if ("number" == typeof e)
                        return e;
                    if ("symbol" == typeof (t = e) || t && "object" == typeof t && jn.call(t) == Vn)
                        return Dn;
                    var t;
                    if (Un(e)) {
                ...
                function Xn(e, t, n) {
                    ...
                    return Un(n) && (i = "leading"in n ? !!n.leading : i,
                        ...
                        function m() {
                            ...
                            n) {
                                if (void 0 === l)
                                    ...
                                    u ? f(e) : s;
                                if (h)
                                    return l = setTimeout(p, r),
                                    f(c)
                            }
                            return void 0 === l && (l = setTimeout(p, r)),
                            s
                        }
                        return r = qn(r) || 0,
                        Un(e) && (u = !!e.leading,
                        n = (h = "maxWait"in e) ? Yn(qn(e.maxWait) || 0, r) : n,
                ...
                function li(e) {
                    if ("number" == typeof e)
                        return e;
                    if ("symbol" == typeof (t = e) || t && "object" == typeof t && "[object Symbol]" == ri.call(t))
                        return NaN;
                    var t;
                    if (si(e)) {
                        var n = "function" == typeof e.valueOf ? e.valueOf() : e;
                ...
                function ci(i, r, e) {
                    ...
                    return r = li(r) || 0,
                    si(e) && (u = !!e.leading,
                    n = (h = "maxWait"in e) ? ai(li(e.maxWait) || 0, r) : n,
                    t = "trailing"in e ? !!e.trailing : t),
                    m.cancel = function() {
                        void 0 !== l && clearTimeout(l),
                        a = c = o = l = void (d = 0)
                ...
                function Bi(r, a) {
                    if ("function" != typeof r || a && "function" != typeof a)
                    ...
                    return o.cache = new (Bi.Cache || Di),
                    o
                }
                function Hi(e) {
                    var t = typeof e;
                ...
                Oi.prototype.set = function(e, t) {
                    return this.__data__[e] = Ei && void 0 === t ? hi : t,
                    this
                }
                ,
                ...
                Pi.prototype.delete = function(e) {
                    var t = this.__data__
                      , n = Vi(t, e);
                    return !(n < 0 || (n == t.length - 1 ? t.pop() : Li.call(t, n, 1),
                    0))
                }
                ,
                ...
                Zi.prototype.connect_ = function() {
                    ...
                    Ui ? (this.mutationsObserver_ = new MutationObserver(this.refresh),
                ...
                Zi.getInstance = function() {
                    return this.instance_ || (this.instance_ = new Zi),
                    this.instance_
                }
                ,
                Zi.instance_ = null,
                ...
                function er(e) {
                    return Wi ? Qi(e) ? tr(0, 0, (t = e.getBBox()).width, t.height) : function(e) {
                        ...
                        Math.round(l + o) !== n && (l -= Ji(i, "top", "bottom") + o)),
                ...
                qe && window.addEventListener("resize", function() {
                    ur !== window.devicePixelRatio && (ur = window.devicePixelRatio,
                    dr = null)
                });
                var fr = function() {
                    function l(e, t) {
                        ...
                        this.onPointerEvent = function(e) {
                            ...
                            e.stopPropagation(),
                            "mousedown" === e.type && (t && (s.axis.x.scrollbar.rect = s.axis.x.scrollbar.el.getBoundingClientRect(),
                            s.isWithinBounds(s.axis.x.scrollbar.rect) ? s.onDragStart(e, "x") : s.onTrackClick(e, "x")),
                            n && (s.axis.y.scrollbar.rect = s.axis.y.scrollbar.el.getBoundingClientRect(),
                        ...
                        this.drag = function(e) {
                            ...
                            o = s.isRtl && l.getRtlHelpers().isRtlScrollingInverted ? -o : o),
                        ...
                        l.instances.has(this.el) || (this.recalculate = Xn(this.recalculate.bind(this), 64),
                    ...
                    e.onTrackClick = function(e, i) {
                        ...
                        !function e() {
                            var t, n;
                            -1 == o ? s < a && (a -= 40,
                            r.contentWrapperEl.scrollTo(((t = {})[r.axis[i].offsetAttr] = a,
                            t)),
                            window.requestAnimationFrame(e)) : a < s && (a += 40,
                            r.contentWrapperEl.scrollTo(((n = {})[r.axis[i].offsetAttr] = a,
                            n)),
                ...
                wr.call(xr, "a"),
                wr.call(Mr, "a"),
                0 !== xr.lastIndex || 0 !== Mr.lastIndex), kr = void 0 !== /()??/.exec("")[1];
                (Cr || kr) && (Sr = function(e) {
                    var t, n, i, r;
                ...
                function Lr(n, e, t, i) {
                    ...
                    if (!a || !o || "replace" === n && !Pr || "split" === n && !Dr) {
                        ...
                        ge(RegExp.prototype, r, 2 == e ? function(e, t) {
                ...
                Lr("match", 1, function(i, c, d) {
                    ...
                    , function(e) {
                        ...
                        for (var r, a = n.unicode, o = [], s = n.lastIndex = 0; null !== (r = Er(n, i)); ) {
                            var l = String(r[0]);
                            "" === (o[s] = l) && (n.lastIndex = Ar(i, ee(n.lastIndex), a)),
                            s++
                        }
                        return 0 === s ? null : o
                    }
                ...
                Lr("replace", 2, function(r, M, w) {
                    ...
                    , function(e, t) {
                        ...
                        for (var d, u = "", h = 0, f = 0; f < l.length; f++) {
                            c = l[f];
                            for (var g = String(c[0]), p = Rr(zr(Q(c.index), r.length), 0), v = [], m = 1; m < c.length; m++)
                ...
                fr.initHtmlApi = function() {
                    ...
                    "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(fr.handleMutations),
    ...
    6: [function(e, t, n) {
        ...
        var i = e("./hasClass.js")
          , r = i.classListSupport ? function(e, t) {
            (0,
            i.hasClass)(e, t) || e.classList.add(t)
        }
        : function(e, t) {
            (0,
    ...
    16: [function(e, t, n) {
        ...
        n.Events = function() {
            return {
                ...
                emit: function(t, n) {
                    n.type = t,
                    this.topics[t] && this.topics[t].forEach(function(e) {
                        e(n, t)
                    })
                }
            }
    ...
    25: [function(e, t, n) {
        ...
        n.has3DTransforms = function(e) {
            ...
            if (!window.getComputedStyle)
                return !1;
            var t, n = document, i = (0,
            s.getBody)(), r = (0,
            l.setFakeBody)(i), a = n.createElement("p"), o = 9 < e.length ? "-" + e.slice(0, -9).toLowerCase() + "-" : "";
            return o += "transform",
            i.insertBefore(a, null),
            a.style[e] = "translate3d(1px,1px,1px)",
            t = window.getComputedStyle(a).getPropertyValue(o),
            i.fake ? (0,
            c.resetFakeBody)(i, r) : a.remove(),
    ...
    31: [function(e, t, n) {
        ...
        n.jsTransform = function(t, n, i, r, e, a, o) {
            var s = Math.min(a, 10)
              , l = 0 <= e.indexOf("%") ? "%" : "px"
              , c = (e = e.replace(l, ""),
            Number(t.style[n].replace(i, "").replace(r, "").replace(l, "")))
              , d = (e - c) / a * s;
            setTimeout(function e() {
                a -= s,
                c += d,
                t.style[n] = i + c + l + r,
                0 < a ? setTimeout(e, s) : o()
            }, s)
        }
    }
    , {}],
    32: [function(e, t, n) {
        ...
        n.mediaquerySupport = function() {
            ...
            s.getBody)(), i = (0,
            l.setFakeBody)(n), r = t.createElement("div"), a = t.createElement("style"), o = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}";
            a.type = "text/css",
    ...
    34: [function(e, t, n) {
        ...
        n.percentageLayout = function() {
            var e, t = document, n = (0,
            l.getBody)(), i = (0,
            c.setFakeBody)(n), r = t.createElement("div"), a = t.createElement("div"), o = "";
            ...
            r.appendChild(a),
            n.appendChild(r),
            e = Math.abs(r.getBoundingClientRect().left - a.children[67].getBoundingClientRect().left) < 2,
            n.fake ? (0,
            d.resetFakeBody)(n, i) : r.remove(),
            e
        }
        ;
        var l = e("./getBody.js")
    ...
    36: [function(e, t, n) {
        ...
        n.removeAttrs = function(e, t) {
            e = (0,
            a.isNodeList)(e) || e instanceof Array ? e : [e];
    ...
    38: [function(e, t, n) {
        ...
        var i = e("./hasClass.js")
          , r = i.classListSupport ? function(e, t) {
            (0,
            i.hasClass)(e, t) && e.classList.remove(t)
        }
        : function(e, t) {
            (0,
            i.hasClass)(e, t) && (e.className = e.className.replace(t, ""))
        }
        ;
        n.removeClass = r
    }
    ...
    40: [function(e, t, n) {
        ...
        n.resetFakeBody = function(e, t) {
            e.fake && (e.remove(),
            i.docElement.style.overflow = t,
            i.docElement.offsetHeight)
        }
        ;
    ...
    41: [function(e, t, n) {
        ...
        n.setAttrs = function(e, t) {
            if (e = (0,
            r.isNodeList)(e) || e instanceof Array ? e : [e],
    ...
    42: [function(e, t, n) {
        ...
        n.setFakeBody = function(e) {
            var t = "";
            e.fake && (t = i.docElement.style.overflow,
            e.style.background = "",
            e.style.overflow = i.docElement.style.overflow = "hidden",
    ...
    46: [function(e, t, n) {
        ...
        n.whichProperty = function(t) {
            ...
            for (var e = document.createElement("fakeelement"), r = (t.length,
            0); r < t.length; r++) {
                var a = t[r];
                if (void 0 !== e.style[a])
                    return a
    ...
    47: [function(e, t, n) {
        ...
        n.tns = void 0,
        e("./helpers/Object.keys"),
        e("./helpers/childNode.remove");
        ...
        n.tns = function e(A) {
            ...
            if (n) {
                var i = navigator.userAgent
                  , a = new Date;
                try {
                    (t = v.localStorage) ? (t.setItem(a, a),
                    n = t.getItem(a) == a,
                    t.removeItem(a)) : n = !1,
                    n || (t = {})
                } catch (e) {
            ...
            var m = t.tC ? (0,
            Ci.checkStorageValue)(t.tC) : (0,
            ki.setLocalStorage)(t, "tC", (0,
            Li.calc)(), n)
              , y = t.tPL ? (0,
            Ci.checkStorageValue)(t.tPL) : (0,
            ki.setLocalStorage)(t, "tPL", (0,
            Ai.percentageLayout)(), n)
              , O = t.tMQ ? (0,
            Ci.checkStorageValue)(t.tMQ) : (0,
            ki.setLocalStorage)(t, "tMQ", (0,
            Ei.mediaquerySupport)(), n)
              , o = t.tTf ? (0,
            Ci.checkStorageValue)(t.tTf) : (0,
            ki.setLocalStorage)(t, "tTf", (0,
            $i.whichProperty)("transform"), n)
              , s = t.t3D ? (0,
            Ci.checkStorageValue)(t.t3D) : (0,
            ki.setLocalStorage)(t, "t3D", (0,
            Zi.has3DTransforms)(o), n)
              , b = t.tTDu ? (0,
            Ci.checkStorageValue)(t.tTDu) : (0,
            ki.setLocalStorage)(t, "tTDu", (0,
            $i.whichProperty)("transitionDuration"), n)
              , l = t.tTDe ? (0,
            Ci.checkStorageValue)(t.tTDe) : (0,
            ki.setLocalStorage)(t, "tTDe", (0,
            $i.whichProperty)("transitionDelay"), n)
              , x = t.tADu ? (0,
            Ci.checkStorageValue)(t.tADu) : (0,
            ki.setLocalStorage)(t, "tADu", (0,
            $i.whichProperty)("animationDuration"), n)
              , c = t.tADe ? (0,
            Ci.checkStorageValue)(t.tADe) : (0,
            ki.setLocalStorage)(t, "tADe", (0,
            $i.whichProperty)("animationDelay"), n)
              , d = t.tTE ? (0,
            Ci.checkStorageValue)(t.tTE) : (0,
            ki.setLocalStorage)(t, "tTE", (0,
            Ki.getEndProperty)(b, "Transition"), n)
              , u = t.tAE ? (0,
            Ci.checkStorageValue)(t.tAE) : (0,
            ki.setLocalStorage)(t, "tAE", (0,
            Ki.getEndProperty)(x, "Animation"), n)
            ...
            if (f.forEach(function(e) {
                if ("string" == typeof A[e]) {
                    ...
                    if (g[e] = t,
                    !n || !n.nodeName)
                        return void (h && console.warn("Can't find", A[e]));
                    A[e] = n
                }
            }),
            !(A.container.children.length < 1)) {
                ...
                Oi.createStyleSheet)(), Me = A.lazyload, we = (A.lazyloadSelector,
                []), _e = le ? (X = function() {
                    {
                        if (Z || K && !re)
                            return j - 1;
                        var e = K ? "fixedWidth" : "items"
                          , t = [];
                        if ((K || A[e] < j) && t.push(A[e]),
                        P)
                            for (var n in P) {
                                var i = P[n][e];
                                i && (K || i < j) && t.push(i)
                            }
                        return t.length || t.push(0),
                        Math.ceil(K ? re / Math.min.apply(null, t) : Math.max.apply(null, t))
                    }
                }(),
                $ = V ? Math.ceil((5 * X - j) / 2) : 4 * X - j,
                $ = Math.max(X, $),
                nn("edgePadding") ? $ + 1 : $) : 0, Se = V ? j + 2 * _e : j + _e, Ce = !(!K && !Z || le), ke = K ? qn() : null, Te = !V || !le, Le = N ? "left" : "top", Ae = "", Ee = "", Oe = K ? function() {
                ...
                , Pe = Zt(rn("startIndex")), De = Pe, Ve = ($t(),
                0), Re = Z ? null : Oe(), ze = A.preventActionWhenRunning, Be = A.swipeAngle, He = !Be || "?", Ne = !1, Ie = A.onInit, Fe = new er.Events, We = " tns-slider tns-" + A.mode, je = F.id || (0,
                Ti.getSlideId)(), Ye = rn("disable"), Ge = !1, Ue = A.freezable, qe = !(!Ue || Z) && bn(), Xe = !1, $e = {
                    ...
                    click: function(e) {
                        ...
                        Fi.hasAttr)(t, "data-nav")) {
                            ...
                            Wi.getAttr)(t, "data-nav"))
                              , i = K || Z ? n * j / _t : n * ne;
                            ti(rt ? n : Math.min(Math.ceil(i), j - 1), e),
                            kt === n && (Pt && si(),
                            Ct = -1)
                        }
                    },
                    ...
                    error: function(e) {
                        !function(e) {
                            (0,
                            Ni.addClass)(e, "failed"),
                            En(e)
                        }(ui(e))
                    }
                }, ut = "force" === A.preventScrollOnTouch;
                if (nt)
                    var ht, ft, gt = A.controlsContainer, pt = A.controlsContainer ? A.controlsContainer.outerHTML : "", vt = A.prevButton, mt = A.nextButton, yt = A.prevButton ? A.prevButton.outerHTML : "", bt = A.nextButton ? A.nextButton.outerHTML : "";
                if (it)
                    var xt, Mt = A.navContainer, wt = A.navContainer ? A.navContainer.outerHTML : "", _t = Z ? j : bi(), St = 0, Ct = -1, kt = Jt(), Tt = kt, Lt = "tns-nav-active", At = "Carousel Page ", Et = " (Current Slide)";
                if (at)
                    var Ot, Pt, Dt, Vt, Rt, zt = "forward" === A.autoplayDirection ? 1 : -1, Bt = A.autoplayButton, Ht = A.autoplayButton ? A.autoplayButton.outerHTML : "", Nt = ["<span class='tns-visually-hidden'>", " animation</span>"];
                if (ot || st)
                    var It, Ft, Wt = {}, jt = {}, Yt = !1, Gt = N ? function(e, t) {
                        return e.x - t.x
                    }
                    : function(e, t) {
                        return e.y - t.y
                ...
                Ae = "translate",
                Ee = s ? (Ae += N ? "3d(" : "3d(0px, ",
                N ? ", 0px, 0px)" : ", 0px)") : (Ae += N ? "X(" : "Y(",
                ")")),
                V && (F.className = F.className.replace("tns-vpfix", "")),
                function() {
                    nn("gutter");
                    C.className = "tns-outer",
                    I.className = "tns-inner",
                    C.id = je + "-ow",
                    I.id = je + "-iw",
                    "" === F.id && (F.id = je);
                    We += y || Z ? " tns-subpixel" : " tns-no-subpixel",
                    We += m ? " tns-calc" : " tns-no-calc",
                    Z && (We += " tns-autowidth");
                    We += " tns-" + A.axis,
                    F.className += We,
                    V ? ((S = E.createElement("div")).id = je + "-mw",
                    S.className = "tns-ovh",
                    C.appendChild(S),
                    S.appendChild(I)) : C.appendChild(I);
                    if (ce) {
                        (S || I).className += " tns-ah"
                    }
                    if (k.insertBefore(C, F),
                    I.appendChild(F),
                    (0,
                    Bi.forEach)(W, function(e, t) {
                        (0,
                        Ni.addClass)(e, "tns-item"),
                        e.id || (e.id = je + "-item" + t),
                        !V && B && (0,
                        Ni.addClass)(e, B),
                        (0,
                ...
                function() {
                    ...
                    N && (y || Z ? ((0,
                    Pi.addCSSRule)(xe, "#" + je + " > .tns-item", "font-size:" + v.getComputedStyle(W[0]).fontSize + ";", (0,
                    Vi.getCssRulesLength)(xe)),
                    (0,
                    Pi.addCSSRule)(xe, "#" + je, "font-size:0;", (0,
                    Vi.getCssRulesLength)(xe))) : V && (0,
                    Bi.forEach)(W, function(e, t) {
                    ...
                    if (O) {
                        if (b) {
                            ...
                            (0,
                            Pi.addCSSRule)(xe, "#" + je + "-mw", i, (0,
                            Vi.getCssRulesLength)(xe))
                        }
                        i = an(A.edgePadding, A.gutter, A.fixedWidth, A.speed, A.autoHeight),
                        (0,
                        Pi.addCSSRule)(xe, "#" + je + "-iw", i, (0,
                        Vi.getCssRulesLength)(xe)),
                        V && (i = N && !Z ? "width:" + on(A.fixedWidth, A.gutter, A.items) + ";" : "",
                        b && (i += dn(oe)),
                        (0,
                        Pi.addCSSRule)(xe, "#" + je, i, (0,
                        Vi.getCssRulesLength)(xe))),
                        i = N && !Z ? sn(A.fixedWidth, A.gutter, A.items) : "",
                        A.gutter && (i += ln(A.gutter)),
                        V || (b && (i += dn(oe)),
                        x && (i += un(oe))),
                        i && (0,
                        Pi.addCSSRule)(xe, "#" + je + " > .tns-item", i, (0,
                        Vi.getCssRulesLength)(xe))
                    } else {
                        Rn(),
                        I.style.cssText = an(J, Q, K, ce),
                        V && N && !Z && (F.style.width = on(K, Q, ne));
                        i = N && !Z ? sn(K, Q, ne) : "";
                        Q && (i += ln(Q)),
                        i && (0,
                        Pi.addCSSRule)(xe, "#" + je + " > .tns-item", i, (0,
                ...
                : function() {
                  ...
                  , qt = V ? function() {
                    ...
                    oe && (0,
                    Xi.isVisible)(F) || ei()) : (0,
                    tr.jsTransform)(F, Le, Ae, Ee, Xn(), oe, ei),
                    N || yi()
                }
                : function() {
                    we = [];
                ...
                return {
                    ...
                    destroy: function() {
                        ...
                        ae && (0,
                        Qi.removeEvents)(E, Qe),
                        gt && (0,
                        Qi.removeEvents)(gt, $e),
                        Mt && (0,
                        Qi.removeEvents)(Mt, Ze),
                        (0,
                        Qi.removeEvents)(F, Ke),
                        (0,
                        Qi.removeEvents)(F, Je),
                        Bt && (0,
                        Qi.removeEvents)(Bt, {
                            click: li
                        }),
                        ...
                        fe && (0,
                        Qi.removeEvents)(F, et),
                        ge && (0,
                        Qi.removeEvents)(F, tt);
                        ...
                        for (var t in f.forEach(function(e, t) {
                            ...
                            if ("object" === nr(n)) {
                                var i = !!n.previousElementSibling && n.previousElementSibling
                                  , r = n.parentNode;
                                n.outerHTML = a[t],
                                A[e] = i ? i.nextElementSibling : r.firstElementChild
                            }
                        }),
            ...
            function $t() {
                for (var e = V ? Pe - _e : Pe; e < 0; )
                    e += j;
                return e % j + 1
            }
            function Zt(e) {
                return e = e ? Math.max(0, Math.min(le ? j - 1 : j - ne, e)) : 0,
                V ? e + _e : e
            }
            function Kt(e) {
                for (null == e && (e = Pe),
            ...
            function tn() {
                ...
                return function e(t) {
                    ...
                    i = (n = r.getBoundingClientRect()).right - n.left,
                    r.remove(),
                    i || e(t.parentNode)
                }(k) - e
            }
            ...
            function rn(e, t) {
                if (null == t && (t = Y),
                "items" === e && K)
                    return Math.floor((ee + Q) / (K + Q)) || 1;
                var n = A[e];
                if (P)
                    for (var i in P)
                        t >= parseInt(i) && e in P[i] && (n = P[i][e]);
                return "slideBy" === e && "page" === n && (n = rn("items")),
                V || "slideBy" !== e && "items" !== e || (n = Math.floor(n)),
                n
            }
            function an(e, t, n, i, r) {
                ...
                if (void 0 !== e) {
                    var o = e;
                    t && (o -= t),
                    a = N ? "margin: 0 " + o + "px 0 " + e + "px;" : "margin: " + e + "px 0 " + o + "px 0;"
                } else if (t && !n) {
                    var s = "-" + t + "px";
                    a = "margin: 0 " + (N ? s + " 0 0" : "0 " + s + " 0") + ";"
                }
                return !V && r && b && i && (a += dn(i)),
                a
            }
            function on(e, t, n) {
            ...
            function hn() {
                if (nn("autoHeight") || Z || !N) {
                    ...
                    Bi.forEach)(e, function(e) {
                        var t = e.src;
                        t && t.indexOf("data:image") < 0 ? ((0,
                        Ji.addEvents)(e, dt),
                        e.src = "",
                        e.src = t,
                        (0,
                        Ni.addClass)(e, "loading")) : Me || An(e)
                    }),
                    (0,
                    wi.raf)(function() {
                        Dn((0,
                        Gi.arrayFromNodeList)(e), function() {
                            U = !0
                        })
                    }),
                    !Z && N && (e = On(Pe, Math.min(Pe + ne - 1, Se - 1))),
                    Me ? fn() : (0,
                    wi.raf)(function() {
                        Dn((0,
                        Gi.arrayFromNodeList)(e), fn)
                    })
                } else
                    V && $n(),
                    pn(),
            ...
            function pn() {
                ...
                at) {
                    ...
                    Bt = C.querySelector("[data-action]")),
                    Bt && (0,
                    Ji.addEvents)(Bt, {
                        click: li
                    }),
                ...
                if (it) {
                    if (Mt)
                        ...
                        for (var t = "", n = rt ? "" : 'style="display:none"', i = 0; i < j; i++)
                            t += '<button data-nav="' + i + '" tabindex="-1" aria-controls="' + je + '" ' + n + ' aria-label="' + At + (i + 1) + '"></button>';
                        t = '<div class="tns-nav" aria-label="Carousel Pagination">' + t + "</div>",
                        C.insertAdjacentHTML(en(A.navPosition), t),
                        Mt = C.querySelector(".tns-nav"),
                        xt = Mt.children
                    }
                    if (xi(),
                    b) {
                        ...
                        r && (a = "-" + r + "-" + a),
                        (0,
                        Pi.addCSSRule)(xe, "[aria-controls^=" + je + "-item]", a, (0,
                        Vi.getCssRulesLength)(xe))
                    }
                    (0,
                    ji.setAttrs)(xt[kt], {
                    ...
                    (0,
                    Yi.removeAttrs)(xt[kt], "tabindex"),
                    (0,
                    Ni.addClass)(xt[kt], Lt),
                    (0,
                    Ji.addEvents)(Mt, Ze)
                }
                ...
                vt && mt || (vt = gt.children[0],
                mt = gt.children[1]),
                A.controlsContainer && (0,
                ji.setAttrs)(gt, {
                    "aria-label": "Carousel Navigation",
                    tabindex: "0"
                }),
                (A.controlsContainer || A.prevButton && A.nextButton) && (0,
                ji.setAttrs)([vt, mt], {
                    "aria-controls": je,
                    tabindex: "-1"
                }),
            ...
            function vn() {
                ...
                fe && (0,
                Ji.addEvents)(F, et, A.preventScrollOnTouch),
                ge && (0,
                Ji.addEvents)(F, tt),
                ae && (0,
                Ji.addEvents)(E, Qe),
                "inner" === D ? Fe.on("outerResized", function() {
                    yn(),
                    Fe.emit("innerLoaded", Mi())
                }) : (P || K || Z || ce || !N) && (0,
                Ji.addEvents)(v, {
                    resize: mn
                }),
            ...
            function yn(e) {
                if (G) {
                    "outer" === D && Fe.emit("outerResized", Mi(e)),
                    Y = Qt();
                    var t, n = H, i = !1;
                    P && (xn(),
                    (t = n !== H) && Fe.emit("newBreakpointStart", Mi(e)));
                    ...
                    t && Ye !== s && (Ye ? Sn() : function() {
                        ...
                        le)
                            for (var e = _e; e--; )
                                ...
                                qi.showElement)(W[e]),
                                (0,
                                qi.showElement)(W[Se - e - 1]);
                        if (!V)
                            for (var t = Pe, n = Pe + j; t < n; t++) {
                                var i = W[t]
                                  , r = t < Pe + ne ? R : B;
                                i.style.left = 100 * (t - Pe) / ne + "%",
                                (0,
                                Ni.addClass)(i, r)
                            }
                        wn(),
                    ...
                    Ue && (t || K || Z) && (qe = bn()) !== l && (qe ? (Zn(Xn(Zt(0))),
                    _n()) : (function() {
                        if (!Xe)
                            return;
                        J && O && (I.style.margin = "");
                        if (_e)
                            for (var e = "tns-transparent", t = _e; t--; )
                                V && (0,
                                Ii.removeClass)(W[t], e),
                                (0,
                                Ii.removeClass)(W[Se - t - 1], e);
                        wn(),
                        Xe = !1
                    }(),
                    i = !0)),
                    ...
                    Qi.removeEvents)(E, Qe)),
                    de !== d && (de ? gt ? (0,
                    qi.showElement)(gt) : (vt && (0,
                    qi.showElement)(vt),
                    mt && (0,
                    qi.showElement)(mt)) : gt ? (0,
                    Ui.hideElement)(gt) : (vt && (0,
                    Ui.hideElement)(vt),
                    mt && (0,
                    Ui.hideElement)(mt))),
                    he !== u && (he ? (0,
                    ...
                    Ui.hideElement)(Mt)),
                    fe !== h && (fe ? (0,
                    Ji.addEvents)(F, et, A.preventScrollOnTouch) : (0,
                    Qi.removeEvents)(F, et)),
                    ge !== f && (ge ? (0,
                    Ji.addEvents)(F, tt) : (0,
                    Qi.removeEvents)(F, tt)),
                    ...
                    be !== v && (be ? (0,
                    Ji.addEvents)(E, Je) : (0,
                    Qi.removeEvents)(E, Je)),
                    t) {
                        if (K === y && te === M || (i = !0),
                        ce !== b && (ce || (I.style.height = "")),
                        de && ue !== x && (vt.innerHTML = ue[0],
                        mt.innerHTML = ue[1]),
                        Bt && me !== w) {
                            var C = pe ? 1 : 0
                              , k = Bt.innerHTML
                    ...
                    if ((a || K && !Z) && (_t = bi(),
                    xi()),
                    (r = Pe !== m) ? (Fe.emit("indexChanged", Mi()),
                    i = !0) : a ? r || Vn() : (K || Z) && (Ln(),
                    Nn(),
                    Cn()),
                    a && !V && function() {
                        for (var e = Pe + Math.min(j, ne), t = Se; t--; ) {
                            var n = W[t];
                            Pe <= t && t < e ? ((0,
                            Ni.addClass)(n, "tns-moving"),
                            n.style.left = 100 * (t - Pe) / ne + "%",
                            (0,
                            Ni.addClass)(n, R),
                            (0,
                            Ii.removeClass)(n, B)) : n.style.left && (n.style.left = "",
                            (0,
                            Ni.addClass)(n, B),
                            (0,
                            Ii.removeClass)(n, R)),
                        ...
                        setTimeout(function() {
                            (0,
                            Bi.forEach)(W, function(e) {
                                (0,
                                Ii.removeClass)(e, "tns-moving")
                            })
                        }, 300)
                    }(),
                    !Ye && !qe) {
                        if (t && !O && (ce === autoheightTem && oe === speedTem || Rn(),
                        J === S && Q === _ || (I.style.cssText = an(J, Q, K, oe, ce)),
                        N)) {
                            V && (F.style.width = on(K, Q, ne));
                            var L = sn(K, Q, ne) + ln(Q);
                            (0,
                            Di.removeCSSRule)(xe, (0,
                            Vi.getCssRulesLength)(xe) - 1),
                            (0,
                            Pi.addCSSRule)(xe, "#" + je + " > .tns-item", L, (0,
                            Vi.getCssRulesLength)(xe))
                        }
                        ce && Pn(),
                        i && ($n(),
            ...
            function bn() {
                if (!K && !Z)
                    return j <= (te ? ne - (ne - 1) / 2 : ne);
                var e = K ? (K + Q) * j : L[j]
                  , t = J ? ee + 2 * J : ee + Q;
                return te && (t -= K ? (ee - K) / 2 : (ee - (L[Pe + 1] - L[Pe] - Q)) / 2),
                e <= t
            }
            function xn() {
                for (var e in H = 0,
            ...
            function _n() {
                if (!Xe) {
                    if (J && (I.style.margin = "0px"),
                    _e)
                        for (var e = "tns-transparent", t = _e; t--; )
                            V && (0,
                            Ni.addClass)(W[t], e),
                            (0,
                            Ni.addClass)(W[Se - t - 1], e);
                    Mn(),
                    Xe = !0
                }
            }
            function Sn() {
                if (!Ge) {
                    if (xe.disabled = !0,
                    F.className = F.className.replace(We.substring(1), ""),
                    (0,
                    Yi.removeAttrs)(F, ["style"]),
                    le)
                        for (var e = _e; e--; )
                            V && (0,
                            Ui.hideElement)(W[e]),
                            (0,
                            Ui.hideElement)(W[Se - e - 1]);
                    if (N && V || (0,
                    Yi.removeAttrs)(I, ["style"]),
                    !V)
                        for (var t = Pe, n = Pe + j; t < n; t++) {
                            var i = W[t];
                            (0,
            ...
            function Tn(e) {
                ...
                Z)
                    ...
                    if (K) {
                        var t = K + Q;
                        n = te || J ? (a = Math.floor(i / t),
                        Math.ceil(r / t - 1)) : a + Math.ceil(ee / t) - 1
                    } else if (te || J) {
                        var o = ne - 1;
                        if (n = te ? (a -= o / 2,
                        Pe + o / 2) : Pe + o,
            ...
            function Ln() {
                Me && !Ye && On.apply(null, Tn()).forEach(function(e) {
                    ...
                    Hi.hasClass)(e, ct)) {
                        ...
                        Ji.addEvents)(e, dt),
                        e.src = (0,
                        Wi.getAttr)(e, "data-src");
                        var n = (0,
                        Wi.getAttr)(e, "data-srcset");
                        n && (e.srcset = n),
                        (0,
                        Ni.addClass)(e, "loading")
                    }
                })
            }
            function An(e) {
                (0,
                Ni.addClass)(e, "loaded"),
                En(e)
            }
            function En(e) {
                (0,
                Ni.addClass)(e, "tns-complete"),
                (0,
                Ii.removeClass)(e, "loading"),
                (0,
                Qi.removeEvents)(e, dt)
            }
            function On(e, t) {
                for (var n = []; e <= t; )
                    (0,
                    Bi.forEach)(W[e].querySelectorAll("img"), function(e) {
                        n.push(e)
                    }),
                    e++;
                return n
            ...
            function zn(e, t) {
                for (var n = [], i = e, r = Math.min(e + t, Se); i < r; i++)
            ...
            function Hn() {
                ...
                (0,
                Bi.forEach)(W, function(e, t) {
                    t && L.push(e.getBoundingClientRect()[n] - r),
                    t === Se - 1 && L.push(e.getBoundingClientRect()[i] - r)
                })
            }
            function Nn() {
                var e = Tn()
                ...
                Bi.forEach)(W, function(e, t) {
                    n <= t && t <= i ? (0,
                    Fi.hasAttr)(e, "aria-hidden") && ((0,
                    Yi.removeAttrs)(e, ["aria-hidden", "tabindex"]),
                    (0,
                    Ni.addClass)(e, lt)) : (0,
                    Fi.hasAttr)(e, "aria-hidden") || ((0,
                    ji.setAttrs)(e, {
            ...
            function Un(e) {
                return null == e && (e = Pe),
                Z ? (ee - (J ? Q : 0) - (L[e + 1] - L[e] - Q)) / 2 : K ? (ee - K) / 2 : (ne - 1) / 2
            }
            function qn() {
            ...
            function Kn(e, t, n, i) {
                ...
                for (var a = e; a < r; a++) {
                    var o = W[a];
                    i || (o.style.left = 100 * (a - Pe) / ne + "%"),
                    _ && l && (o.style[l] = o.style[c] = _ * (a - e) / 1e3 + "s"),
                    (0,
                    Ii.removeClass)(o, t),
                    (0,
                    Ni.addClass)(o, n),
            ...
            function Jn(e, t) {
                Te && Ut(),
                Pe === De && !t || (Fe.emit("indexChanged", Mi()),
                Fe.emit("transitionStart", Mi()),
                ce && Pn(),
                Pt && e && 0 <= ["click", "keydown"].indexOf(e.type) && si(),
                Ne = !0,
                qt())
            }
            function Qn(e) {
            ...
            function ti(e, t) {
                if (!qe)
                    if ("prev" === e)
                        ...
                        isNaN(e) || (t || (e = Math.max(0, Math.min(j - 1, e))),
                        i = e - n)),
                        !V && i && Math.abs(i) < ne) {
                            var r = 0 < i ? 1 : -1;
            ...
            function ni(e, t) {
                ...
                var n;
                if (!t) {
                    for (var i = ui(e = di(e)); i !== gt && [vt, mt].indexOf(i) < 0; )
                        i = i.parentNode;
                ...
                if (se) {
                    if (Pe === Ve && -1 === t)
                        return void ti("last", e);
                    if (Pe === Re && 1 === t)
                        return void ti("first", e)
                }
                t && (Pe += ie * t,
                Z && (Pe = Math.floor(Pe)),
                Jn(n || e && "keydown" === e.type ? e : null))
            }
            function ii() {
            ...
            function gi() {
                return (0,
                zi.getTouchDirection)((0,
                Ri.toDegree)(jt.y - Wt.y, jt.x - Wt.x), Be) === A.axis
            }
            function pi(e) {
                if (Ne) {
                    if (ze)
                ...
                jt.x = Wt.x = t.clientX,
                jt.y = Wt.y = t.clientY,
                V && (It = parseFloat(F.style[Le].replace(Ae, "")),
                Gn(F, "0s"))
            }
            function vi(e) {
                if (Yt) {
                        ...
                        wi.raf)(function() {
                            if (N && !Z) {
                                ...
                                if (t <= 0)
                                    ...
                                    for (var n = 0; n < Se && t >= L[n]; )
                                        t > L[Pe = n] && r < 0 && (Pe += 1),
                                        n++
                            }
                            Jn(i, r),
                            Fe.emit(hi(i) ? "touchEnd" : "dragEnd", Mi(i))
                        }) : He && ni(i, 0 < r ? -1 : 1)
                    }
                }
                "auto" === A.preventScrollOnTouch && (ut = !1),
                Be && (He = "?"),
                pe && !Pt && ii()
            }
            function yi() {
    ...
    51: [function(e, t, n) {
        ...
        !function() {
            for (var e, t, n, i = 1; ; ) {
                ...
                t = 32,
                n = 8,
                e.container.style.width = "".concat(e.slideCount * t + (e.slideCount - 1) * n, "px"),
                i++
            }
        }()
    }
    ...
    53: [function(e, t, n) {
        ...
        e("../utils/core").querySelector(".form-counter", function(e) {
            ...
            try {
                ...
                }, a = e[Symbol.iterator](); !(t = (o = a.next()).done); t = !0)
                    r()
            } catch (e) {
                n = !0,
                i = e
        ...
        e("../utils/core").querySelector(".form-input", function(e) {
            ...
            try {
                for (var r, a = function() {
                    var e = r.value;
                    if (e.classList.contains("always-active"))
                        return "continue";
                ...
                }, o = e[Symbol.iterator](); !(t = (r = o.next()).done); t = !0)
                    a()
            } catch (e) {
                n = !0,
                i = e
            ...
            try {
                for (var a, r = function() {
                    for (var e = a.value, o = "filled", s = Array.from(e.children), i = function() {
                        ...
                        for (var e = s.indexOf(this), t = 0; t <= e; t++)
                            s[t].classList.add(o);
                        for (var n = e + 1; n < s.length; n++)
                            s[n].classList.remove(o);
                        i()
                    }, n = 0, r = s; n < r.length; n++) {
                        r[n].addEventListener("click", t)
                    }
                    i()
                }, o = e[Symbol.iterator](); !(t = (a = o.next()).done); t = !0)
                    r()
            } catch (e) {
                n = !0,
                i = e
        ...
        e("../utils/core").querySelector(".interactive-input", function(e) {
            ...
            try {
                for (var a, r = function() {
                    ...
                    if (n) {
                        var i = function e(t) {
                            27 === t.keyCode && (n.value = "",
                            r(),
                            window.removeEventListener("keydown", e))
                        }
                          , r = function() {
                            "" !== n.value ? (e.classList.add("active"),
                            window.addEventListener("keydown", i)) : "" === n.value && (e.classList.remove("active"),
    ...
    59: [function(e, t, n) {
        ...
        i.querySelector("#profile-completion-chart", function(e) {
            ...
            n.addColorStop(0, "#41efff"),
            n.addColorStop(1, "#615dfa");
            var i = {
                datasets: [{
                    data: [59, 41],
    ...
    65: [function(e, t, n) {
        ...
        e("../utils/core").querySelector("#search-main", function(e) {
            ...
            960 < window.innerWidth && (i.addEventListener("input", function(e) {
                "" === r && "" !== e.target.value ? (n.showDropdowns(),
                window.addEventListener("keydown", t)) : "" === e.target.value && (n.hideDropdowns(),
                window.removeEventListener("keydown", t)),
                r = e.target.value
            }),
        ...
        r.querySelector(".content-grid", function(o) {
            ...
            r.querySelector("#chat-widget-messages", function(e) {
                ...
                m.addEventListener("click", function() {
                    ...
                    t(),
                    c.chat.active = !n.classList.contains(i),
                    l()
                }),
                t(),
                window.addEventListener("resize", t),
            ...
            r.querySelector(".navigation-widget-trigger", function(e) {
                ...
                n.addEventListener("click", function() {
                    ...
                    r.classList.toggle("delayed"),
                    r.classList.toggle(a),
                    c.navigation.active = !i.classList.contains(a),
                    l()
                }),
                t(),
                window.addEventListener("resize", t)
            ...
            r.querySelector(".navigation-widget-mobile-trigger", function(e) {
                ...
                function l() {
                    ...
                    (n.classList.contains("hidden") ? o : a)()
                }
    ...
    69: [function(e, t, n) {
        ...
        var r = {
            deepExtend: function(e, t) {
                for (var n in t)
                    "object" === i(t[n]) ? (e[n] = t[n]instanceof Array ? [] : {},
            ...
            liquidify: function(e) {
                ...
                e.style.background = 'url("'.concat(n, '") no-repeat center'),
                e.style.backgroundSize = "cover"
            },
            liquidifyStatic: function(e, t) {
                t.style.display = "none",
                e.style.background = 'url("'.concat(t.getAttribute("src"), '") no-repeat center'),
                e.style.backgroundSize = "cover"
            },
            ...
            function t(e) {
                var t = document.createElement("div")
                  ...
                  , i = function(e) {
                    ...
                    return t.classList.add("icon-".concat(e)),
                    n.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", "#svg-".concat(e)),
                    t.appendChild(n),
                    t
                }(e.className)
        ...
        var r = e("tiny-slider/src/tiny-slider")
          ...
          , o = {
            createTab: function(e) {
                if (i(e.triggers) && i(e.elements))
                    return new XM_Tab(e)
            },
            createHexagon: function(e) {
                if (i(e.container))
                    return new XM_Hexagon(e)
            },
            ...
            createDropdown: function(e) {
                if (i(e.container) && e.controlToggle || i(e.trigger) && i(e.container))
                    return new XM_Dropdown(e)
            },
            createTooltip: function(e) {
                if (i(e.container))
                    return new XM_Tooltip(e)
            },
            ...
            createPopup: function(e) {
                if (i(e.container) && i(e.trigger))
                    return new XM_Popup(e)
            },
           closePopup: function(e) {
            ...
            createAccordion: function(e) {
                if (i(e.triggerSelector) && i(e.contentSelector))
